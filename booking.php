<?php
	...
	if ($action == 'view') {
		 ...
		 LEFT JOIN vehicle_type as vt on vt.iVehicleTypeId=cb.iVehicleTypeId WHERE 1".$cmp_ssql . "  ORDER BY `cb`.`iCabBookingId` DESC";
...
<html lang="en" dir="<?php echo (isset($_SESSION['eDirectionCode']) && $_SESSION['eDirectionCode'] != "")?$_SESSION['eDirectionCode']:'ltr';?>">
	<head>
		...
		<title><?php echo $SITE_NAME?> | <?php echo $langage_lbl['LBL_MY_BOOKINGS']; ?></title>
		...
		<div id="main-uber-page">
			...
			<div class="page-contant">
				<div class="page-contant-inner">
					<h2 class="header-page trip-detail driver-detail1"><?php echo $langage_lbl['LBL_MY_BOOKINGS']; ?><a href="javascript:void(0);" onClick="manual_dispatch_form();"><?php echo $langage_lbl['LBL_ADD_BOOKING']; ?></a></h2>
					<!-- trips page -->
										...
										<tbody>
											<?php for ($i = 0; $i < count($data_drv); $i++) { ?>
												<tr class="gradeA">
													...
													<td><?php echo  jdate('dS M Y,',strtotime($data_drv[$i]['dBooking_date'])); ?> <?php echo  jdate('H:i',strtotime($data_drv[$i]['dBooking_date'])); ?></td>
