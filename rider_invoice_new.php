							...
							<div class="col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<b>Your trip</b> <?php echo @jdate('h:i A',@strtotime($db_trip[0]['tStartDate']));?> در تاریخ <?php echo @jdate('d M Y',@strtotime($db_trip[0]['tStartDate']));?>
										...
										<div class="row">
											<!-- <div class="col-sm-12">
												<?php if($db_user[0]['vImgName'] != '' && file_exists($tconfig["tsite_upload_images_panel"].'/'.$db_user[0]['vImgName'])){?>
													<img src = "<?php echo $tconfig["tsite_upload_images"].$db_user[0]['vImgName']?>" style="width:200px;height:150px;"/>
													<?php }else{ ?>
												...
												<?php if($db_driver[0]['vImage'] != '' && file_exists($tconfig["tsite_upload_images_panel"].'/'.$db_driver[0]['vImage'])){?>
													<img src = "<?php echo $tconfig["tsite_upload_images"].$db_driver[0]['vImage']?>" style="width:200px;height:150px;"/>
													<?php }else{ ?>
													<img src="assets/img/profile-user-img.png" alt="" style="width:200px;height:150px;">
												<?php } ?>
											...
											<div class="col-sm-6 rider-invoice-new-left">
                                                ...
                                                <b><?php echo @jdate('h:i A',@strtotime($db_trip[0]['tStartDate']));?><p><?php echo $db_trip[0]['tSaddress'];?></p></b></span>
                                                
												<span class="location-to"><i class="icon-map-marker"></i> <b><?php echo @jdate('h:i A',@strtotime($db_trip[0]['tEndDate']));?><p><?php echo $db_trip[0]['tDaddress'];?></p></b></span>
												
                                                <div class="rider-invoice-bottom">
												<div class="col-sm-4">
														Car<br /> <b><?php echo $db_trip[0]['eCarType'];?></b><br/>
												</div>
												<div class="col-sm-4">
														Distance<br /> <b><?php echo $db_trip[0]['fDistance'];?></b> <br/>
												</div>
												<div class="col-sm-4">
											...
											<div class="col-sm-6 rider-invoice-new-right">
												...
												<table style="width:100%" cellpadding="5" cellspacing="0" border="0">
													<tr>
															<td>Basic Fare  </td>
															<td><?php echo $generalobj->trip_currency($db_trip[0]['iBaseFare'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
															<td>Distance</td>
															<td><?php echo $generalobj->trip_currency($db_trip[0]['fPricePerKM'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
															<td>Time</td>
															<td><?php echo $generalobj->trip_currency($db_trip[0]['fPricePerMin'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
															<td>Commision </td>
															<td><?php echo $generalobj->trip_currency($db_trip[0]['fCommision'],$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></td>
													</tr>
													<tr>
															<td colspan="2"><hr style="margin-bottom:0px"/></td>
													</tr>
													<tr>
															<td><b>Total Fare (Via <?php echo $db_trip[0]['vTripPaymentMode']?>)</b></td>
															<td><b><?php echo $generalobj->trip_currency($tot,$db_trip[0]['fRatioPassenger'],$db_trip[0]['vCurrencyPassenger']);?></b></td>
													</tr>
											...
											<div class="col-sm-12">
												<!--<table style="width:100%; background-color:#f1f1f1;">
													<tr>
															...
															<td width="25%">
																	<span>You ride with <?php echo  $db_driver[0]['vName']?></span>
															</td>
															<td width="25%">
																	RATE YOUR RIDE
															</td>
															<td width="25%">
																<?php echo $db_ratings[0]['vRating1'];?>
															</td>
													</tr>
												</table>-->
