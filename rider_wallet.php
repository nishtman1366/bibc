			...
			<div class="page-contant-inner">
			  	...
			  	<div class="trips-page">
					<div class="wallet-balance">
						<p>موجودی کیف پول: <span style="color: green"><?php echo  $transferAmount + $generalobj->get_user_available_balance($_SESSION['sess_iUserId'], $type); ?> <?php echo  $_SESSION["sess_currency_smybol"]; ?></span></p>

						<?php if($_SESSION['sess_user'] == 'rider') : ?>
						<div class="singlerow-login-log">
							<a href="javascript:void(0);" data-toggle="modal" data-target="#uiModals1"><?php echo $langage_lbl['LBL_ADD_MONEY']; ?></a>
						</div>
						<?php endif; ?>
					</div>
			  		<form name="search" action="" method="post" onSubmit="return checkvalid()">
				    	...
				    	<div class="time-period">
				      		...
				      		<b><button class="driver-trip-btn"><?php echo $langage_lbl['LBL_Wallet_Search']; ?></button></b>
			      		</div>
		      		</form>
			    	<div class="trips-table">
			      		...
			      		<div class="driver-trip-table">
			        		<table width="100%" border="0" cellpadding="0" cellspacing="1" id="dataTables-example" <?php echo $rtls; ?>>
								...
								?>
									<tr class="gradeA">
										<td align="center" data-order="<?php echo $db_trip[$i]['tDescription']?>"><?php echo $db_trip[$i]['tDescription'];?></td>
										<td align="right" class="center"><?php echo $generalobj->userwalletcurrency($db_trip[$i]['fRatio_'.$_SESSION["sess_vCurrency"]],$iBalance,$_SESSION["sess_vCurrency"]);?></td>
								...
								<?php }?>
									<tr class="gradeA odd ">
										 ...
										 <td rowspan="1" colspan="1" align="right" style="font-weight:bold;text-align:right;"><?php echo $langage_lbl['LBL_TOTAL_BALANCE']?></td>
          								 <td rowspan="1" colspan="1" align="center" class="center"><?php echo $final;?></td>
									</tr>
								<?}else{ ?>
								   <!--  <tr class="odd">
...
<!-- add money SAVAR-->
<div class="col-lg-12">
    <div class="modal fade" id="uiModals1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-content image-upload-1 popup-box1">
            <div class="upload-content">
                <h4><?php echo $langage_lbl['LBL_ADD_MONEY'];?></h4>
	                 <form class="form-horizontal" id="addmoney" method="post" enctype="multipart/form-data" action="payment/" name="addmoney">
