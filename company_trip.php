			  	...
			  	<div class="trips-page">
			  		...
			  		<input type="hidden" name="action" value="search" />
                        ...
                        <div class="Posted-date" style="margin-top:20px">
                                ...
                                <input type="password" id="" name="exp_password" placeholder="رمز گرفتن خروجی" class="fform-control" style="min-width:100px" value=""/>
                                <a style="text-align: center;min-width:100px" href="javascript:void(0);" class="btn btn-danger driver-trip-btn"  onClick="exportlist();">خروجی گرفتن</a>
				    	...
				    	<div class="time-period">
                            ...
                            <span style="margin-top:10px">
                                <label>شمارش تعداد سفر هر راننده<input type="checkbox" id="counter" name="counter" class="form-control" value="yes" <?php if($counter == 'yes') echo 'checked' ?> style="float: right;width: 20px;margin: auto;height: 20px;" /></label>
                        ...
                        <div class="driver-trip-table">
			        		<table width="100%" border="0" cellpadding="0" cellspacing="1" id="dataTables-example">
								...
								?>
									...
									<?php if($APP_TYPE != 'UberX'){ ?>
										<td ><?php echo  $i + 1 ?></td>
										<td ><?php echo $trip_type;?> <br> <?php echo $db_trip[$i]['vRideNo'];?></td>
										<?php } ?>
										...
										<?php if($db_trip[$i]['vCancelReason'] != '') :
                                            ?><a style="color:red" href="javascript:alert('<?php echo  $db_trip[$i]['vCancelReason'] . '\n' . $db_trip[$i]['vCancelComment']; ?>')"><?php echo $langage_lbl['LBL_CANCELED']; ?></a>
                                            <?php else : ?>
                                            <?php echo $langage_lbl['LBL_CANCELED']; ?>
                                            <?php endif; ?>
                                            <br>
                                            <a href="invoice.php?iTripId=<?php echo base64_encode(base64_encode($db_trip[$i]['iTripId']))?>" target="_blank">
