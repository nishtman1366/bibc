			      			...
			      			<form  name="frmbooking" id="frmbooking" method="post" action="payment_request_a.php">
			        			...
			        			<table width="100%" border="0" cellpadding="0" cellspacing="0" id="dataTables-example" <?php echo $rtls; ?>>
										...
										<?php $fareTotal = $commTotal = $payTotal = 0;
										  for($i=0;$i<count($db_dtrip);$i++)
										  {
												...
												<tr class="gradeA">
													...
													<td ><?php echo  date('d M Y',strtotime($db_dtrip[$i]['tEndDate']));?></td>
													<td ><?php echo  $tripcursymbol;?><?php echo $fare; $fareTotal += $fare; ?></td>
													<td><?php echo  $tripcursymbol;?><?php echo $Commission; $commTotal += $Commission; ?></td>
													<td class="center"><?php echo  $tripcursymbol;?><?php echo $payment; $payTotal += $payment; ?></td>
									...
									<tr class="last_row_record">
										<td></td><td></td><td class="last_record_row"><?php echo  $tripcursymbol;?><?php echo /* $curr_code." ". */$fareTotal; ?></td><td class="last_record_row midddle_rw"><?php echo  $tripcursymbol;?><?php echo /* $curr_code." ". */$commTotal; ?></td><td class="last_record_row"><?php echo  $tripcursymbol;?><?php echo /* $curr_code." ". */$payTotal; ?></td><td></td><td></td>
									</tr>
									</tfoot>
		        				</table>
		        				<!--table>
