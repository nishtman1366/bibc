...
<div id="main-uber-page">
    ...
    <div class="page-contant">
        <div class="page-contant-inner">
            <h2 class="header-page trip-detail driver-detail1"><?php echo $langage_lbl['LBL_DRIVER_COMPANY_TXT']; ?><a
                        href="javascript:void(0);"
                        onClick="add_driver_form();"><?php echo $langage_lbl['LBL_ADD_DRIVER_COMPANY_TXT']; ?></a> <a
                        href="?type=online">رانندگان آنلاین</a> <a href="driver_requests.php">آخرین درخواست ها</a></h2>

            <!-- trips page -->
            <div class="trips-page trips-page1">

                <div class="col-lg-12">
                    <div class="gmap-div gmap-div1" style="height:400px;">
                        <div id="map" class="gmap3" style="height:400px;"></div>
                    </div>
                </div>
                ...
                <script>
                    ...
                    /* START COUNT QUERY */
                    if ($_GET['id'] == "") {
                        $whereicpmpany = " and iCompanyId=" . $comp_list;

                        if ($_GET['driver'] != "") {
                            $whereicpmpany .= " and iDriverId=" . $_GET['driver'];
                        }
                    } else {
                        $whereicpmpany = " and iCompanyId='' and vLongitude != ''";
                    }
                    /* START COUNT QUERY */
                    ...
                    var myLat = <?php echo floatval($data_drv[$i]['vLatitude']) ?>;
                    var myLng = <?php echo floatval($data_drv[$i]['vLongitude']) ?>;
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="dataTables-example">
                                ...
                                <?php for ($i = 0; $i < count($data_drv); $i++) { ?>
                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td class="center">
                                            ...
                                            <?php else : ?>
                                                ...
                                                <?php if ($data_drv[$i]['vLatitude'] != '') : ?>
                                                    <a href="https://maps.google.com/?q=<?php echo $data_drv[$i]['vLatitude']; ?>,<?php echo $data_drv[$i]['vLongitude']; ?>"
                                                       target="_blank" <?php if (time() - $lastOnlineTime < 1800) echo 'style="color:red"' ?>>نمایش</a>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        ...
                                        <td align="center">
                                            <form name="delete_form_<?php echo $data_drv[$i]['iDriverId']; ?>"
                                                  id="delete_form_<?php echo $data_drv[$i]['iDriverId']; ?>"
                                                  method="post" action="" class="margin0">
                                                <input type="hidden" name="hdn_del_id" id="hdn_del_id"
                                                       value="<?php echo $data_drv[$i]['iDriverId']; ?>">
                                                <input type="hidden" name="action" id="action" value="delete">
                                                <button type="button" class="btn btn-danger"
                                                        onClick="confirm_delete('<?php echo $data_drv[$i]['iDriverId']; ?>');">
