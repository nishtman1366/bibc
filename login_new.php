		...
		<div class="page-contant">
			<div class="page-contant-inner">
				...
				<p style="display:none;" class="btn-block btn btn-rect btn-success error-login-v" id="success" ></p>
						...
						<div class="login-form-left"> <form action="
...
<!-- Mamad H . A . M (End) -->
							...
							" class="form-signin" method = "post" id="login_box" onSubmit="return chkValid('<?php echo $action?>');" >
							<b>

								<input type="hidden" name="action" value="<?echo $action?>"/>
                                <label><?php echo $langage_lbl['LBL_EMAIL_LBL_TXT']?></label>
								<input name="vEmail" type="text" placeholder="<?php echo $langage_lbl['LBL_EMAIL_LBL_TXT']; ?>" class="login-input" id="vEmail" value="<?php echo ($action == 'rider')?$rider_email:$driver_email;?>" required /></b>
                                <b>
                                 <label><?php echo $langage_lbl['LBL_PASSWORD_LBL_TXT']?></label>
								<input name="vPassword" type="password" placeholder="<?php echo $langage_lbl['LBL_PASSWORD_LBL_TXT']; ?>" class="login-input" id="vPassword" value="" required />
							</b>
							<b>
                        ...
                        <form action="" method="post" class="form-signin" id="frmforget" onSubmit="return forgotPass();" style="display: none;">
							...
							<b>
                            <label><?php echo $langage_lbl['LBL_EMAIL_LBL_TXT']?></label>
								<input name="femail" type="text" placeholder="<?php echo $langage_lbl['LBL_EMAIL_LBL_TXT']; ?>" class="login-input" id="femail" value="" required />
							</b>
							<b>
								<input type="submit" class="submit-but" value="<?php echo $langage_lbl['LBL_Recover_Password']; ?>" />
