    ...
    <div class="page-contant">
        <div class="page-contant-inner">
                    ...
                    if ($db_user[0]['vLicence'] == '' || $db_user[0]['vCerti'] == '' || $db_user[0]['vNoc'] == '') {
                        ...
                        <div class="demo-warning">
                            <p>
                                ...
                                } ?><?php echo $langage_lbl['LBL_KINDLY_PROVIDE_BELOW_VISIBLE']; ?>
                            </p>
                        </div>
                        <?php
                    }
            ...
            <div class="driver-profile-page">
                ...
                <?php } else if ($success == 0 && ($var_msg != "" || $er != "")) {
                    ?>
                    <div class="demo-danger msgs_hide">
                        <button class="demo-close" type="button">×</button>
                        <?php echo $var_msg; ?>
                ...
                <div class="driver-profile-top-part" id="hide-profile-div">
                    <div class="driver-profile-img">
									<span>
                                        ...
                                        <?php } else {
                                            ...
                                            <img src="<?php echo $img_path . '/' . $_SESSION['sess_iUserId'] . '/2_' . $db_data[0]['vImage'] ?>"
                                                 style="height:150px;"/>
                                        <?php } ?>
									</span>
                        <b>
                    ...
                    <div class="driver-profile-info">
                        <h3><?php if ($_SESSION['sess_user'] == 'driver') {
                                echo $db_user[0]['vName'] . " " . $db_user[0]['vLastName'];
                        ...
                        <?php if ($_SESSION['sess_user'] == 'driver') {
                            if ($REFERRAL_SCHEME_ENABLE == 'Yes') {
                                ...
                                ?>
                                <p> <?php echo $langage_lbl['MY_REFERAL_CODE']; ?>&nbsp;
                                    : <?php echo $db_user[0]['vRefCode'] ?></p>

                                <?php
                            }
                        } ?>
                        <span><a id="show-edit-profile-div"><i class="fa fa-pencil"
                                                               aria-hidden="true"></i><?php echo $langage_lbl['LBL_PROFILE_EDIT']; ?></a></span>
                    </div>
                </div>
                <!-- form -->
                <div class="edit-profile-detail-form" id="show-edit-profile" style="display: none;">
                    <form id="frm1" method="post" action="javascript:void(0);">
                        ...
                        <input type="hidden" class="edit" name="vCurrencyDriver"
                               value="<?php echo $db_user[0]['vCurrencyDriver'] ?>">
                        <div class="show-edit-profile-part">
										<span>
											<label><?php echo $langage_lbl['LBL_PROFILE_YOUR_EMAIL_ID']; ?></label>
											<input type="hidden" name="uid" id="u_id1"
                                                   value="<?php echo $_SESSION['sess_iUserId']; ?>">
											<input type="email" id="in_email" class="edit-profile-detail-form-input"
                                                   placeholder="<?php echo $langage_lbl['LBL_PROFILE_YOUR_EMAIL_ID']; ?>"
                                                   value="<?php echo $db_user[0]['vEmail'] ?>"
                                                   name="email" <?php echo isset($db_user[0]['vEmail']) ? '' : ''; ?>  required
                                                   oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                            ...
                            if ($_SESSION['sess_user'] == 'driver') {
                                ...
                                <span>
												...
												<input type="text" class="edit-profile-detail-form-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_YOUR_FIRST_NAME']; ?>"
                                                       value="<?php echo $db_user[0]['vName'] ?>" name="name" required
                                                       oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                                                       oninput="setCustomValidity('')">
											</span>
                                <span>
												...
												<input type="text" class="edit-profile-detail-form-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_YOUR_LAST_NAME']; ?>"
                                                       value="<?php echo $db_user[0]['vLastName'] ?>" name="lname"
                                                       required
                                                       oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                                                       oninput="setCustomValidity('')">
											</span>
                                ...
                                <span>
												...
												<input type="text" class="edit-profile-detail-form-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_COMPANY_NAME_TXT']; ?>"
                                                       value="<?php echo $db_user[0]['vCompany'] ?>" name="vCompany"
                                                       required
                                                       oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                                                       oninput="setCustomValidity('')">
											</span>
                            ...
                            <span>
												...
												<input type="text" class="edit-profile-detail-form-input"
                                                       value="<?php echo $db_user[0]['dBirthDate'] ?>" name="dBirthDate"
                                                       style="background: #e1e1e1;" o disabled>
											</span>
                            <!--
										<span>
                            ...
                            <span>
											...
											<input type="text" pattern=".{10}" class="input-phNumber1" id="code"
                                                   name="vCode" value="<?php echo $db_user[0]['vCode'] ?>" readonly>
											<input name="phone" type="text" value="<?php echo $db_user[0]['vPhone'] ?>"
                                                   class="edit-profile-detail-form-input input-phNumber2"
                                                   placeholder="<?php echo $langage_lbl['LBL_Phone_Number']; ?>"
                            ...
                            if ($_SESSION['sess_user'] == 'driver' && $APP_TYPE == 'UberX') {
                                ...
                                <span>
                                            ...
                                            <textarea name="tProfileDescription" rows="3" cols="40" class="form-control"
                                                      ...
                                                      placeholder="<?php echo $langage_lbl['LBL_PROFILE_DESCRIPTION']; ?>"><?php echo $db_user[0]['tProfileDescription'] ?></textarea>
											</span>
                            <?php } ?>
                            <p>
                                <input name="save" type="submit" value="<?php echo $langage_lbl['LBL_Save']; ?>"
                                       class="save-but" onClick="return validate_email_submit('login')">
                                <input name="" id="hide-edit-profile-div" type="button"
                                       value="<?php echo $langage_lbl['LBL_BTN_PROFILE_CANCEL_TRIP_TXT']; ?>"
                                       class="cancel-but">
                            </p>
                        ...
                        <li <?php if ($_SESSION['sess_user'] == 'driver') { ?> class='driver-profile-mid-part-details' <?php } else { ?> class='company-profile-mid-part-details' <?php } ?> >
                            ...
                            <div class="flipbox">
                                ...
                                <div class="driver-profile-mid-inner back">
                                    ...
                                    <h3><?php echo $langage_lbl['LBL_PROFILE_ADDRESS']; ?></h3>
                                    <p><?php echo $db_user[0]['vCaddress'] . ',' . $db_user[0]['vCadress2'] ?></p>
                                    <span><a id="show-edit-address-div-back" class="hide-address-div hidev"><i
                                                    class="fa fa-pencil"
                                                    aria-hidden="true"></i><?php echo $langage_lbl['LBL_PROFILE_EDIT']; ?></a></span>
                                </div>
                            </div>
                        ...
                        <li <?php if ($_SESSION['sess_user'] == 'driver') { ?> class='driver-profile-mid-part-details' <?php } else { ?>class='company-profile-mid-part-details' <?php } ?>>
                            <div class="flipbox">
                                ...
                                <div class="driver-profile-mid-inner back">
                                    ...
                                    <p><?php for ($i = 0; $i < strlen($generalobj->decrypt($db_user[0]['vPassword'])); $i++)
                                            echo '*'; ?></p>
                                    <span><a id="show-edit-password-div-back" class="hide-password-div hidev"><i
                                                    class="fa fa-pencil"
                                                    aria-hidden="true"></i><?php echo $langage_lbl['LBL_PROFILE_EDIT']; ?></a></span>
                                </div>
                            </div>
                            ...
                            <li <?php if ($_SESSION['sess_user'] == 'driver') { ?> class='driver-profile-mid-part-details' <?php } else { ?>class='company-profile-mid-part-details' <?php } ?>>
                                <div class="flipbox">
                                    ...
                                    <div class="driver-profile-mid-inner back">
                                        ...
                                        <p><?php echo $db_user[0]['vBankName'] ?></p>
                                        <?php if (count($db_lang) >= 1) { ?>
                                            <span><a id="show-edit-bankdetail-div-back"
                                                     class="hide-bankdetail-div hidev"><i class="fa fa-pencil"
                                                                                          aria-hidden="true"></i><?php echo $langage_lbl['LBL_PROFILE_EDIT']; ?></a></span>
                                        <?php } ?>
                                    </div>
                                </div>
                ...
                <div class="profile-Password showV" id="show-edit-address" style="display: none;">
                    <form id="frm2" method="post" onsubmit="return editPro('address')">
                        ...
                        <h3><i class="fa fa-map-marker"
                               aria-hidden="true"></i><?php echo $langage_lbl['LBL_PROFILE_ADDRESS']; ?></h3>
                        ...
                        <div class="profile-address-part">
										<span>
											...
											<input type="text" class="profile-address-input"
                                                   placeholder="<?php echo $langage_lbl['LBL_PROFILE_ADDRESS']; ?> 1"
                                                   value="<?php echo $db_user[0]['vCaddress'] ?>" name="address1"
                                                   required
                                                   oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                                                   oninput="setCustomValidity('')">
										</span>
                            <span>
										...
										<input type="text" class="profile-address-input"
                                               placeholder="<?php echo $langage_lbl['LBL_ADDRESS2_TXT']; ?>"
                                               value="<?php echo $db_user[0]['vCadress2'] ?>" name="address2" required
                                               oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                        ...
                        <span>
										<b>
											<input name="save" type="submit"
                                                   ...
                                                   class="profile-Password-save">
											<input name="" id="hide-edit-address-div" type="button"
                                                   value="<?php echo $langage_lbl['LBL_BTN_PROFILE_CANCEL_TRIP_TXT']; ?>"
                ...
                <div class="profile-Password showV" id="show-edit-password" style="display: none;">
                    <form id="frm3" method="post" onSubmit="return validate_password()">
                        ...
                        <h3><i class="fa fa-unlock-alt"
                               aria-hidden="true"></i><?php echo $langage_lbl['LBL_PROFILE_PASSWORD_LBL_TXT']; ?></h3>
                        ...
                        <div class="row password-l">
                            <div class="col-md-4">
											<span>
												...
												<input type="password" class="input-box"
                                                       placeholder="<?php echo $langage_lbl['LBL_CURR_PASS_HEADER']; ?>"
                            ...
                            <div class="col-md-4">
											<span>
												...
												<input type="password" class="input-box"
                                                       placeholder="<?php echo $langage_lbl['LBL_UPDATE_PASSWORD_HEADER_TXT']; ?>"
                                                       name="npass" id="npass" required
                                                       oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                                                       oninput="setCustomValidity('')">
											</span>
                            </div>
                            <div class="col-md-4">
											<span>
												...
												<input type="password" class="input-box"
                                                       placeholder="<?php echo $langage_lbl['LBL_Confirm_New_Password']; ?>"
                                                       name="ncpass" id="ncpass" required
                                                       oninvalid="this.setCustomValidity('<?php echo $langage_lbl['LBL_REQUIRED_TEXT']; ?>')"
                                                       oninput="setCustomValidity('')">
											</span>
                            </div>
                        ...
                        <span>
										<b>
											<input name="save" type="submit"
                                                   value="<?php echo $langage_lbl['LBL_Save']; ?>"
                                                   class="profile-Password-save">
											<input name="" id="hide-edit-password-div" type="button"
                                                   value="<?php echo $langage_lbl['LBL_BTN_PROFILE_CANCEL_TRIP_TXT']; ?>"
                                                   class="profile-Password-cancel">
										</b>
									</span>
                ...
                if ($_SESSION['sess_user'] == 'driver') { ?>
                    ...
                    <div class="profile-Password showV" id="show-edit-bankdeatil" style="display: none;">
                        <form id="frm6" method="post" onsubmit="return editPro('bankdetail')">
                            ...
                            <h3><i class="fa fa-bank"
                                   aria-hidden="true"></i><?php echo $langage_lbl['LBL_BANK_DETAILS_TXT']; ?></h3>
                            <input type="hidden" class="edit" name="action" value="bankdetail">
                            <div class="profile-address-part">
											<span>
												<label><?php echo $langage_lbl['LBL_PAYMENT_EMAIL_TXT']; ?></label>
												<input type="email" class="profile-address-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_PAYMENT_EMAIL_TXT']; ?>"
                                                       value="<?php echo $db_user[0]['vPaymentEmail'] ?>"
                                                       name="vPaymentEmail">
											</span>
                                <span>
												<label> <?php echo $langage_lbl['LBL_ACCOUNT_HOLDER_NAME']; ?></label>
												<input type="text" class="profile-address-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_ACCOUNT_HOLDER_NAME']; ?>"
                                                       value="<?php echo $db_user[0]['vBankAccountHolderName'] ?>"
                                                       name="vBankAccountHolderName"></span>
                                <span>
												<label><?php echo $langage_lbl['LBL_ACCOUNT_NUMBER']; ?></label>
												<input type="text" class="profile-address-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_ACCOUNT_NUMBER']; ?>"
                                                       value="<?php echo $db_user[0]['vAccountNumber'] ?>"
                                                       name="vAccountNumber"></span>
                                <span>
												<label><?php echo $langage_lbl['LBL_NAME_OF_BANK']; ?></label>
											<input type="text" class="profile-address-input"
                                                   placeholder="<?php echo $langage_lbl['LBL_NAME_OF_BANK']; ?>"
                                                   value="<?php echo $db_user[0]['vBankName'] ?>"
                                                   name="vBankName"></span>
                                <span>
												<label><?php echo $langage_lbl['LBL_BANK_LOCATION']; ?></label>
												<input type="text" class="profile-address-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_BANK_LOCATION']; ?>"
                                                       value="<?php echo $db_user[0]['vBankLocation'] ?>"
                                                       name="vBankLocation">
											</span>
                                <span>
												<label><?php echo $langage_lbl['LBL_BIC_SWIFT_CODE']; ?></label>
												<input type="text" class="profile-address-input"
                                                       placeholder="<?php echo $langage_lbl['LBL_BIC_SWIFT_CODE']; ?>"
                                                       value="<?php echo $db_user[0]['vBIC_SWIFT_Code'] ?>"
                            ...
                            <span>
											<b>
												<input name="save" type="submit"
                                                       value="<?php echo $langage_lbl['LBL_Save']; ?>"
                                                       class="profile-Password-save">
												<input name="" id="hide-edit-bankdetail-div" type="button"
                                                       value="<?php echo $langage_lbl['LBL_BTN_PROFILE_CANCEL_TRIP_TXT']; ?>"
                                                       class="profile-Password-cancel">
											</b>
										</span>
                    ...
                    <ul>
                            ...
                            if ($_SESSION['sess_user'] == 'driver') {
                                ...
                                <li>
                                    <?php if ($db_user[0]['vLicence'] != '') {
                                        $img = "assets/img/right-green.png";
                                        $class = "";
                                    } else {
                                        $img = "assets/img/cancel-red.png";
                                        $class = "noc";
                                    }
                                    ?>
                                    <a href="javascript:void(0);" id="NOC_frm15" class="<?php echo $class; ?>"><img
                                                src="<?php echo $img; ?>"
                                                alt="licence"><?php echo $langage_lbl['LBL_PROFILE_DRIVER_LICENCE']; ?>
                                    </a>
                                </li>
                            <? }
                        } ?>
                        ...
                        <li <?php if ($_SESSION['sess_user'] == 'company'){ ?>style="width:48%;"<? } ?>>
                            <?php if ($db_user[0]['vCerti'] != '') {
                                $img1 = "assets/img/right-green.png";
                                $class1 = "";
                            } else {
                                $img1 = "assets/img/cancel-red.png";
                                $class1 = "noc";
                            }
                            ?>
                            <a href="javascript:void(0);" id="NOC_frm8" class="<?php echo $class1; ?>"><img
                                        src="<?php echo $img1; ?>"
                                        alt="verification certificate"><?php echo $langage_lbl['LBL_PROFILE_VERIFICATION_CERTIFICATE']; ?>
                            </a>
                        </li>
                        <li <?php if ($_SESSION['sess_user'] == 'company'){ ?>style="width:48%;"<? } ?>>
                            <?php if ($db_user[0]['vNoc'] != '') {
                                $img2 = "assets/img/right-green.png";
                                $class2 = "";
                            } else {
                                $img2 = "assets/img/cancel-red.png";
                                $class2 = "noc";
                            }
                            ?>
                            <a href="javascript:void(0);" id="NOC_frm7" class="<?php echo $class2; ?>"><img
                                        src="<?php echo $img2; ?>" alt="NOC"><?php echo $langage_lbl['LBL_NOC']; ?></a>
                        </li>
                    </ul>
                    <ul class="last">
                        <?php if ($_SESSION['sess_user'] == 'driver') {
                        ...
                        <li <?php if ($_SESSION['sess_user'] == 'company'){ ?>style="width:48%;"<? } ?>><a
                                    data-toggle="modal" data-target="#uiModal_2" id="NOC_link_frm7">
                                <?
                                if ($db_user[0]['vNoc'] != '') {
                    ...
                    <div class="modal fade" id="uiModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="modal-content image-upload-1 popup-box1">
                            <div class="upload-content">
                                ...
                                <form class="form-horizontal" id="frm15" method="post" enctype="multipart/form-data"
                                      action="upload_doc.php" name="frm15">
                                    ...
                                    <input type="hidden" name="file_name"
                                           value="<?php echo $db_user[0]['vLicence']; ?>"/>
                                                ...
                                                <div class="fileupload-preview thumbnail">
                                                    ...
                                                    <?php } else {
                                                        ...
                                                        if ($file_ext == 'is_image') { ?>
                                                            <img src="<?php echo $tconfig["tsite_upload_driver_doc"] . '/' . $_SESSION['sess_iUserId'] . '/' . $db_user[0]['vLicence'] ?>"
                                                                 style="width:200px;" alt="Licence not found"/>
                                                        <?php } else { ?>
                                                            <a href="<?php echo $tconfig["tsite_upload_driver_doc"] . '/' . $_SESSION['sess_iUserId'] . '/' . $db_user[0]['vLicence'] ?>"
                                                               target="_blank"><?php echo $langage_lbl['LBL_LICENCE_FILE']; ?></a>
                                                        <?php } ?>
                                                        <!-- <a href="#" class="btn btn-danger" data-dismiss="fileupload">X</a> -->
                                                        <a href="#" class="btn btn-danger"
                                                           onClick="return del_docImage('frm15');">X</a>
                                                    <?php } ?>
                                                </div>
                                                <div>
																<span class="btn btn-file btn-success"><span
                                                                            class="fileupload-new"><?php echo $langage_lbl['LBL_UPLOADE_LICENCE']; ?></span>
																<span class="fileupload-exists"><?php echo $langage_lbl['LBL_CHANGE']; ?></span><input
                                                                            type="file" name="licence"/></span>
                                    ...
                                    <div class="col-lg-13 exp-date">
                                        ...
                                        <div class="input-group input-append">
                                            ...
                                            <input class="form-control" type="text" name="dLicenceExp"
                                                   value="<?php echo isset($db_user[0]['dLicenceExp']) ? $db_user[0]['dLicenceExp'] : ' '; ?>"
                                                   readonly="" id="dp3" data-date-format="yyyy/mm/dd"/>
                                            <!-- <span class="input-group-addon add-on"><i class="icon-calendar"></i></span> -->
                                        </div>
                                    </div>
                                    <input type="submit" class="save" name="<?php echo $langage_lbl['LBL_save']; ?>"
                                           value="<?php echo $langage_lbl['LBL_Save']; ?>">
                                    <input type="button" class="cancel" data-dismiss="modal"
                                           name="<?php echo $langage_lbl['LBL_BTN_PROFILE_CANCEL_TRIP_TXT']; ?>"
                                           value="<?php echo $langage_lbl['LBL_BTN_PROFILE_CANCEL_TRIP_TXT']; ?>">
                                </form>
                                <div style="clear:both;"></div>
                            </div>
                        ...
                        <div class="modal-content image-upload-1  popup-box2">
                            <div class="upload-content">
                                ...
                                <form class="form-horizontal" id="frm7" method="post" enctype="multipart/form-data"
                                      action="upload_doc.php" name="frm7">
                                            ...
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-preview thumbnail">
                                                    ...
                                                    <?php } else {
                                                        ...
                                                        if ($file_ext == 'is_image') { ?>
                                                            <img src="<?php echo $img_path . '/' . $_SESSION['sess_iUserId'] . '/' . $db_user[0]['vNoc'] ?>"
                                                                 style="width:200px;" alt="NOC not found"/>
                                                        <?php } else { ?>
                                                            <a href="<?php echo $img_path . '/' . $_SESSION['sess_iUserId'] . '/' . $db_user[0]['vNoc'] ?>"
                                                               target="_blank"><?php echo $langage_lbl['LBL_NOC_FILE']; ?></a>
                                                        <?php } ?>
                                                        <!-- <a href="#" class="btn btn-danger" data-dismiss="fileupload">X</a> -->
                                                        <a href="#" class="btn btn-danger"
                                                           onClick="return del_docImage('frm7');">X</a>
                                                    <?php } ?>
                                                </div>
                                                <div>
                                                    <span class="btn btn-file btn-success"><span
                                                                class="fileupload-new"><?php echo $langage_lbl['LBL_UPLOAD_NOC']; ?></span><span
                                                                class="fileupload-exists"><?php echo $langage_lbl['LBL_CHANGE']; ?></span><input
                                                                type="file" name="noc"/></span>
                                    ...
                                    <input type="submit" class="save" name="save"
                                           value="<?php echo $langage_lbl['LBL_Save']; ?>"><input type="button"
                                                                                                  class="cancel"
                                                                                                  data-dismiss="modal"
                                                                                                  name="cancel"
                                                                                                  value="<?php echo $langage_lbl['LBL_BTN_PROFILE_CANCEL_TRIP_TXT']; ?>">
                ...
                <div class="col-lg-12">
                    <div class="modal fade" id="uiModal_4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                         aria-hidden="true">
                        <div class="modal-content image-upload-1 popup-box3">
                            <div class="upload-content">
                                <h4><?php echo $langage_lbl['LBL_PROFILE_PICTURE']; ?></h4>
                                <form class="form-horizontal" id="frm9" method="post" enctype="multipart/form-data"
                                      action="upload_doc.php" name="frm9">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                ...
                                                <div>
                                                    <span class="btn btn-file btn-success"><span
                                                                class="fileupload-new"><?php echo $langage_lbl['LBL_UPLOAD_PHOTO']; ?></span><span
                                                                class="fileupload-exists"><?php echo $langage_lbl['LBL_CHANGE']; ?></span><input
                                            ...
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-preview thumbnail">
                                                    ...
                                                    <?php } else {
                                                        ...
                                                        if ($file_ext == 'is_image') { ?>
                                                            <img src="<?php echo $img_path . '/' . $_SESSION['sess_iUserId'] . '/' . $db_user[0]['vCerti'] ?>"
                                                                 style="width:200px;" alt="Certificate not found"/>
                                                        <?php } else { ?>
                                                            <a href="<?php echo $img_path . '/' . $_SESSION['sess_iUserId'] . '/' . $db_user[0]['vCerti'] ?>"
                                                               target="_blank"><?php echo $langage_lbl['LBL_CERTIFICATE_FILE']; ?></a>
                                                        <?php } ?>
                                                        <!--<a href="#" class="btn btn-danger" data-dismiss="fileupload">X</a>-->
                                                        <a href="#" class="btn btn-danger"
                                                           onClick="return del_docImage('frm8');">X</a>
                                                    <?php } ?></div>
                                                <div>
																		<span class="btn btn-file btn-success"><span
                                                                                    class="fileupload-new"><?php echo $langage_lbl['LBL_UPLOAD_CERTIFICATE']; ?></span><span
                                                                                    class="fileupload-exists"><?php echo $langage_lbl['LBL_CHANGE']; ?></span>
