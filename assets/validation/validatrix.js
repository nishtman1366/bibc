...
function validatrix(lang=""){
	//Messages
	if(lang=="" || lang=="PS"){
		var warnings = {
		text : '* این قسمت متن مورد نیاز است',
		textarea: '* این ناحیه ی متن مورد نیاز است',
		select: '* انتخاب یک گزینه',
		radio: '* انتخاب یک گزینه رادیویی',
		password : '* این قسمت متن مورد نیاز است',
		checkbox: '* این قسمت متن مورد نیاز است',
		termscheckbox: '* شما باید به توافق برسند به شرایط و ضوابط',
		minpassword: 'رمز عبور باید حداقل 6 کاراکتر طول داشته باشد'
		};
	}else{
		var warnings = {
