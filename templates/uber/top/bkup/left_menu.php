...
<nav>
  ...
  <ul id="listMenu">
    <span class="desktop">
        ...
        <b>
          <a href="sign-up-rider" class="<?php echo (isset($script) && $script == 'Rider Sign-Up')?'active':'';?>"><?php echo $langage_lbl['LBL_SIGN_UP_TO_RIDE']; ?></a>
          <a class="<?php echo (isset($script) && $script == 'Driver Sign-Up')?'active':'';?>" href="sign-up.php"><?php echo $langage_lbl['LBL_BECOME_A_DRIVER']; ?></a>
        </b>
        <?php
          }
          else {
    ...
    <span class="mobile">
        ...
        <?php
          ...
          ?>
              <li><a href="profile" class="<?php echo (isset($script) && $script == 'Profile')?'active':'';?>"> <?php echo $langage_lbl['LBL_MY_PROFILE_HEADER_TXT']; ?></a></li>
              <li><a href="driver" class="<?php echo (isset($script) && $script == 'Driver')?'active':'';?>"><?php echo $langage_lbl['LBL_DRIVER']; ?></a></li>
              <li><a href="vehicle" class="<?php echo (isset($script) && $script == 'Vehicle')?'active':'';?>"><?php echo $langage_lbl['LBL_LEFT_MENU_VEHICLES']; ?></a></li>
