...
<div class="home-hero-page">
	...
	<div class="home-hero-page-right">
		<div class="home-hero-page-right-text"> <span>
			<p>
				<?php echo $langage_lbl['LBL_HOME_RIDING_TXT']; ?>
			</p>
			<a href="sign-up-rider"><em>
				<?php echo $langage_lbl['LBL_HOME_SIGN_UP']; ?>
			</em></a> </span> </div>
	</div>
</div>
<!-- End: Second Section -->
	...
	<div class="get-fare-estimation-inner">
		<div class="get-fare-estimation-left">
			...
			<form name="_fare_estimate_form" id="_fare_estimate_form" method="post" >
				...
				<b><input name="vPickup" type="text" id="from" placeholder="<?php echo $langage_lbl['LBL_ADD_PICKUP_LOC']; ?>" class="trip-start" /></b>
...
<div class="gallery-part">
	<div class="gallery-page">
		<h2><?php echo $langage_lbl['LBL_HOME_MEET_DRIVER']?></h2>
		<em><?php echo $langage_lbl['LBL_HOME_MEET_DRIVER_CONTENT']?></em>
		...
		<?php
			...
			?>
				<div id="box-2" class="box"> <b>
					<img width="290px" id="image-1" src="<?php echo $tconfig["tsite_upload_images"].$db_home_drv[$i]['vImage']?>"/></b>
					<span class="caption full-caption">
					<h3>
						<p><?php echo $db_home_drv[$i]['tText_'.$dlang];?></p>
						<strong><?php echo $db_home_drv[$i]['vName_'.$dlang]?>
