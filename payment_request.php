            ...
            <div class="trips-table">
                <div class="payment-tabs">
                    <ul>
                        <li><a href="javascript:void(0);"
                               onClick="getReview('<?php echo $langage_lbl['LBL_RECENT_RIDE']; ?>');"
                               class="<?php echo $class1; ?>"><?php echo $langage_lbl['LBL_RECENT_RIDE']; ?></a></li>
                        <li><a href="javascript:void(0);"
                               onClick="getReview('<?php echo $langage_lbl['LBL_PAYMENT_REQ']; ?>');"
                               class="<?php echo $class2; ?>"><?php echo $langage_lbl['LBL_PAYMENT_REQ']; ?></a></li>
                        <li><a href="javascript:void(0);"
                               onClick="getReview('<?php echo $langage_lbl['LBL_PAID_TRIP']; ?>');"
                               class="<?php echo $class3; ?>"><?php echo $langage_lbl['LBL_PAID_TRIP']; ?></a></li>
                    </ul>
                </div>
                <div class="trips-table-inner">
                        ...
                        <form name="frmbooking" id="frmbooking" method="post" action="payment_request_a.php">
                            ...
                            <?
                                ...
                                <div class="alert alert-danger alert-dismissable">
                                    ...
                                    "Edit / Delete Record Feature" has been disabled on the Demo Admin Panel. This
                                    feature will be enabled on the main script we will provide you.
                                </div>
                                <?php
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                ...
                                for ($i = 0; $i < count($db_dtrip); $i++) {
                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td><?php echo $fare;
                                            $fareTotal += $fare; ?><?php echo " " . $tripcursymbol; ?></td>
                                        <td><?php echo $Commission;
                                            $commTotal += $Commission; ?><?php echo " " . $tripcursymbol; ?></td>
                                        <td class="center"><?php echo $payment;
                                            $payTotal += $payment; ?><?php echo " " . $tripcursymbol; ?></td>
                                        <td class="center"><a
                                                    href="invoice.php?iTripId=<?php echo base64_encode(base64_encode($db_dtrip[$i]['iTripId'])) ?>"><img
                                                        src="assets/img/invoice1.png"></a>
                                            <? /* if($vstatus=='Yes')
															{
                                        ...
                                        <td>
                                            <div class="checkbox-n">
                                                <input id="payment_<?php echo $db_dtrip[$i]['iTripId']; ?>"
                                                       name="iTripId[]" value="<?php echo $db_dtrip[$i]['iTripId']; ?>"
                                ...
                                <tr class="last_row_record">
                                    <td></td>
                                    <td></td>
                                    <td class="last_record_row"><?php echo /* $curr_code." ". */
                                        $fareTotal; ?><?php echo " " . $tripcursymbol; ?></td>
                                    <td class="last_record_row midddle_rw"><?php echo /* $curr_code." ". */
                                        $commTotal; ?><?php echo " " . $tripcursymbol; ?></td>
                                    <td class="last_record_row"><?php echo /* $curr_code." ". */
                                        $payTotal; ?><?php echo " " . $tripcursymbol; ?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                </tfoot>
                    ...
                    <?php if ($paidtype == $langage_lbl['LBL_RECENT_RIDE']) { ?>
                        <div class="singlerow-login-log"><a href="javascript:void(0);"
                                                            onClick="javascript:check_skills_edit(); return false;"><?php echo $langage_lbl['LBL_Send_transfer_Request']; ?></a>
                        </div>
                        <div class="your-requestd">
                            <b><?php echo $langage_lbl['LBL_THRESHOLDAMOUNT_NOTE1']; ?></b> <?php echo $langage_lbl['LBL_THRESHOLDAMOUNT_NOTE2']; ?><?php echo '  ' . $tripcursymbol . ' ' . number_format($tripcurthholsamt, 2, '.', ''); ?>
                        </div>
                    <?php } ?>
                </div>
            </div>
