...
<body>
<h2>Total Logins/Usage Today: <?php echo $tot_login?></h2>
...
<tr>
	...
	<td style="border: 1px solid #ddd;text-align: left;border-collapse: collapse;padding: 10px;"><?php echo $db_rec[$i]['eMemberType'];?></td>
	<td style="border: 1px solid #ddd;text-align: left;border-collapse: collapse;padding: 10px;"><?php echo $db_rec[$i]['vIP'];?></td>
	<td style="border: 1px solid #ddd;text-align: left;border-collapse: collapse;padding: 10px;"><?php echo $db_rec[$i]['totlogin'];?></td>
	<td style="border: 1px solid #ddd;text-align: left;border-collapse: collapse;padding: 10px;"><?php echo getvisitortype($db_rec[$i]['iMemberId'])?></td>
