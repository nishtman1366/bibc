    ...
    if ($iDriverId != '') {
        ...
        if ($id > 0) {
            ...
            $sql = "SELECT tr.tSecDestination,tr.secDestLatitude,
				tr.secDestLongitude,tr.secDestAddress,tr.tReturn,tr.tEndLat,tr.tEndLong,tr.tDaddress,tr.iUserId FROM trips as tr,register_driver as rd WHERE tr.iTripId=rd.iTripId AND rd.iDriverId = '" . $iDriverId . "'";
            $result = $obj->MySQLSelect($sql);
...
//        if($booking_test)
//            print_r($driver_list_array);
//        if($booking_test)
//            echo "index " .$driver_item_index;
//        if($booking_test)
//            print_r($driver_list_array[$driver_item_index]);
