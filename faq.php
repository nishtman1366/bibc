...
<head>
    ...
    <!--<title><?php echo $COMPANY_NAME?> | Faq</title>-->
    ...
    <!-- End: Left Menu-->
        ...
        <div class="page-contant">
            <div class="page-contant-inner">
                <h2 class="header-page"><?php echo $langage_lbl['LBL_FAQ_TEXT']; ?></h2>
                <!-- contact page -->
                  <div class="faq-page">
				 ...
				 <ul>
					...
					<?php 
						if(count($db_faq_categories)>0)
						{
							...
							{ ?>
								<li <?php if(trim($Type)==trim($db_faq_categories[$i]['vTitle'])){?>class="Active" <?}?>>
									<a href="javascript:void(0);" onClick="getFaqs('<?php echo $db_faq_categories[$i]['vTitle'];?>',<?php echo $db_faq_categories[$i]['iUniqueId'];?>)"><?echo $db_faq_categories[$i]['vTitle'];?></a>
								</li>
							<?
							}
						}
								...
								{?>
											<li class='has-sub'>
												<a href="#" class="faq-q">
													<span>
													<b>Q.</b>
													<h3><?php echo $db_faqs[$i]['Que'];?></h3>
													</span>
													</a>
													<ul class="faq-ans"  style="display:none">
														<li id="faq_<?php echo $db_faqs[$i]['iFaqId']?>">
															<span>  <?php echo $db_faqs[$i]['Ans'];?></span>
														</li>
													</ul>
											</li>
