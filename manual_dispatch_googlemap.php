...
<body>
    ...
    <div class="page-contant">
      <div class="page-contant-inner">
        ...
        <div class="manual-dispatch">
          <a class="btn btn-primary how_it_work_btn" data-toggle="modal" data-target="#myModal"><i class="fa fa-question-circle" style="font-size: 18px;"></i><?php echo  $langage_lbl['LBL_HOW_IT_WORKS'];?></a>
            ...
            <div class="modal-dialog modal-large">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-question-circle" style="font-size: 18px;"></i><?php echo  $langage_lbl['LBL_HOW_IT_WORKS'];?></h4>
                </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-5">
              <form name="add_booking_form" id="add_booking_form" method="post" action="action_booking.php" enctype="multipart/form-data">
                <input type="hidden" name="iCompanyId" id="iCompanyId" value="<?php echo  $_SESSION['sess_iUserId']; ?>">
                ...
                <span>
                  <input type="hidden"  name="vPhoneCode" readonly  class="form-control form-control14" placeholder="Code" id="code" value="<?php echo $vPhoneCode; ?>" />
                  <input type="text" maxlength="12"  title="Please enter 10 digit mobile number." class="form-control add-book-input" name="vPhone"  id="vPhone" value="<?php echo  $vPhone; ?>" onKeyPress="return isNumberKey(event)" placeholder="شماره موبایل" required style="">
                  <a class="btn btn-sm btn-info" id="get_details" ><?php echo  $langage_lbl['LBL_DETAILS'];?></a>
                </span>

                <span> <input type="text" title="Only Alpha character allow" class="form-control first-name1" name="vName"  id="vName" value="<?php echo  $vName; ?>" placeholder="نام">  <input type="text" title="Only Alpha character allow" class="form-control last-name1" name="vLastName"  id="vLastName" value="<?php echo  $vLastName; ?>" placeholder="نام خانوادگی" required></span>
                <!-- Mehrshad Added -->
                <span><input type="text" class="form-control" name="vAddress"  id="vAddress" value="<?php echo  $vAddress; ?>" placeholder="آدرس کاربر(جهت استفاده در مبدا قرار دهید)" >
                </span>
                <span><input type="text" class="form-control" name="vDescription" id="vDescription" value="<?php echo  $vDescription; ?>" placeholder="توضیحات(جهت راهنمایی ادمین)" >
                </span>
                <!-- Mehrshad Added -->
                <span><input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control" name="vEmail" onChange="validate_email(this.value)"  id="vEmail" value="<?php echo  $vEmail; ?>" placeholder="Email" >
                  <div id="emailCheck"></div></span>
                  <span>
                    <input type="text" class="ride-location1 highalert txt_active form-control" name="vSourceAddresss"  id="from" value="<?php echo  $vSourceAddresss; ?>" placeholder="آدرس مبدا" required>
                  </span>
                  <span>
                    <input type="text" class="ride-location1 highalert txt_active form-control" name="tDestAddress"  id="to" value="<?php echo  $tDestAddress; ?>" placeholder="آدرس مقصد" required>
                  </span>
                  <span>
                  ...
                  <span>
                    <textarea type="text" class="ride-location1 highalert txt_active form-control" name="tTripComment"  id="to" value="<?php echo  $tTripComment; ?>" placeholder="توضیحات"></textarea>
                  </span>
                  ...
                  <span>
                    ...
                    <input type="text" class="form-control" name="dBooking_date"  id="datepicker4" value="<?php echo  $dBooking_date; ?>" placeholder="انتخاب تاریخ" required>
                  </span>
                  <span style="position:relative">
                    <input type="text" class="form-control" name="dBooking_time"  id="timepicker5" value="<?php echo  $dBooking_time; ?>" placeholder="انتخاب ساعت" required>
                  </span>
                  <span style="position:relative">
              ...
              <div class="total-price">
                <ul>
                  ...
                  <li><b>فاصله (<em id="dist_fare">0</em> KMs)</b> : <em id="dist_fare_price">0</em> تومان</li>
                  <li><b>زمان (<em id="time_fare">0</em> Minutes)</b> : <em id="time_fare_price">0</em> تومان</li>
                </ul>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" id="dataTables-example">
                  <thead>
                    <tr>
                      ...
                      <th width="15%" style="width: 67px;"><?php echo $langage_lbl['LBL_TRIP_COMMENT'];?></th>
                    ...
                    <?php for ($i = 0; $i < count($data_drv); $i++) { ?>
                      <tr class="gradeA" >
                        ...
                        <?php if ($data_drv[$i]['eStatus'] == "Pending") { ?>
                          <td><a class="btn btn-info" href="manual_dispatch.php?booking_id=<?php echo  $data_drv[$i]['iCabBookingId']; ?>"><i class="icon-shield icon-flip-horizontal icon-white"></i> اختصاص راننده</a><br>( نوع ماشین : <?php echo  $data_drv[$i]['vVehicleType']; ?>)</td>
                        <?php } else if($data_drv[$i]['eCancelBy'] == "Driver" && $data_drv[$i]['eStatus'] == "Cancel") { ?>
                          <td><a class="btn btn-info" href="manual_dispatch.php?booking_id=<?php echo  $data_drv[$i]['iCabBookingId']; ?>"><i class="icon-shield icon-flip-horizontal icon-white"></i> اختصاص راننده</a><br>( نوع ماشین : <?php echo  $data_drv[$i]['vVehicleType']; ?>)</td>
                        <?php } else if ($data_drv[$i]['driver'] != "" && $data_drv[$i]['driver'] != "0") { ?>
                          <td><b><?php echo  $data_drv[$i]['driver']; ?></b><br>( نوع ماشین : <?php echo  $data_drv[$i]['vVehicleType']; ?>) </td>
                        <?php } else  { ?>
                          <td>---<br>( نوع ماشین : <?php echo  $data_drv[$i]['vVehicleType']; ?>)</td>
                        <?php } ?>
                        <td><?php if($data_drv[$i]['iTripId'] != "" && $data_drv[$i]['eStatus'] == "Completed") { ?><a class="btn btn-primary" href="invoice.php?iTripId=<?php echo  base64_encode(base64_encode($data_drv[$i]['iTripId']));?>">View</a><?php }else {echo "---"; } ?></td>
                        ...
                        <?php if ($data_drv[$i]['eStatus'] == "Cancel") { ?>
                          <br /><a href="javascript:void(0);" class="btn btn-info" data-toggle="modal" data-target="#uiModal_<?php echo $data_drv[$i]['iCabBookingId'];?>">دلیل کنسلی</a>
                        <?php } ?>

                        <br />
                        <a class="btn btn-info" href="booking_details.php?booking_id=<?php echo  $data_drv[$i]['iCabBookingId']; ?>" target="_blank"><i class="icon-shield icon-flip-horizontal icon-white"></i>جزئیات بیشتر</a>
                      </td>
                    </tr>
                    <div class="col-lg-12">
  ...
  $('#select_manual').on('click', function () {
    ...
    var centerLat = window.map.center.lat();
    var centerLon = window.map.center.lng();
    ...
    function InitTripsPoint(trips)
    {
      if(typeof trips == "object" && trips.length > 0)
      {
        ...
        for(i=0 ; i < trips.length ; i++)
        {
          ...
          points['startPoint'] = new google.maps.LatLng( trips[i]['tStartLat'],trips[i]['tStartLong']);
