					...
					<div class="footer-text-center">			
						<?php if($add == "Yes"){?>
							...
							<form method="post" action="">
								<input type="hidden" name="vName" id="vName" value="<?php echo $_POST['vName'];?>">
								<input type="hidden" name="vLastName" id="vLastName" value="<?php echo $_POST['vLastName'];?>">
								<input type="hidden" name="vEmail" id="vEmail" value="<?php echo $_POST['vEmail'];?>">
								<input type="hidden" name="vPhone" id="vPhone" value="<?php echo $_POST['vPhone'];?>">
					...
					<form name="frmsignup" id="frmsignup" method="post" action="">
						...
						<div class="contact-form">
							<b>
								<strong>
									<em>First Name:</em><br/>
									<input type="text" name="vName" placeholder="<?php echo $langage_lbl['LBL_CONTECT_US_FIRST_NAME_HEADER_TXT']; ?>" class="contact-input required" value="<?php echo $vName0?>" />
								</strong>
								<strong>
									<em>Last Name:</em><br/>
									<input type="text" name="vLastName" placeholder="<?php echo $langage_lbl['LBL_CONTECT_US_LAST_NAME_HEADER_TXT']; ?>" class="contact-input" value="<?php echo $_vLastName?>" />
								</strong>
								<strong>
									<em>Email address:</em><br/>
									<input type="text" placeholder="<?php echo $langage_lbl['LBL_CONTECT_US_EMAIL_LBL_TXT']; ?>" name="vEmail" value="<?php echo $vEmail?>" autocomplete="off" class="contact-input required"/>
								</strong>
								<strong>
									<em>Phone Number:</em><br/>
									<input type="text" placeholder="777-777-7777" value="<?php echo $vPhone?>" name="vPhone" class="contact-input" />
								</strong>
							</b>
							<b>
