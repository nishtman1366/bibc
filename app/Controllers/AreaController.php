...
//            $error .= 'نام انتخابی تکراریست<br>';
        ...
        if ($error == '') {
            ...
            $polyText .= '))';
            Manager::raw("INSERT INTO `savar_area` (`sAreaName`, `sAreaNamePersian`, `sSpecialArea`, `sPriority`, `sPolygonArea`, `sFeatureCollection`, `sActive`, `mapCenter`, `mapZoom`) VALUES ('$sAreaName', '$sAreaNamePersian', '$sSpecialArea', '$sPriority', PolyFromText('$polyText'), '$sFeatureCollection', '$sActive', '$mapCenter', '$mapZoom');");
        }else{
            die($error);
        }
