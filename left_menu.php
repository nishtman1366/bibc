...
<div id="left">
     <div class="media user-media well-small">
          <a class="user-link" href="#">
               <?php if ($db_data[0]['img'] != '') { ?>
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="<?php echo  $db_data[0]['img'] ?>" style="width:68px;height:68px;"/>
               <?php } else { ?>
          ...
          <div class="media-body">
               <h5 class="media-heading"><?php echo  $db_data[0]['vName'] ?></h5>
     ...
     <ul id="menu" class="collapse">
          <?php if($user == 'company') {?>
         <li class="panel <?php echo (isset($script) && $script == 'Profile')?'active':'';?>">
               <a href="profile.php" >
                    <i class="icon-table"></i> Profile
               </a>
          </li>

         <li class="panel <?php echo (isset($script) && $script == 'Driver')?'active':'';?>">
               <a href="driver.php" >
                    <i class="icon-table"></i> Driver
               </a>
          </li>
          <li class="panel <?php echo (isset($script) && $script == 'Vehicle')?'active':'';?>">
               <a href="vehicle.php" >
           ...
           <li class="panel <?php echo (isset($script) && $script == 'Trips')?'active':'';?>">
		 ...
		 <li class="panel <?php echo (isset($script) && $script == 'payment_request')?'active':'';?>">
