...
<head>
	<meta charset="UTF-8" />
    <title><?php echo $SITE_NAME?> | FAQ Category <?php echo $action;?></title>
        ...
        <!--PAGE CONTENT -->
         <div id="content">
            <div class="inner">
				<div class="row">
					<div class="col-lg-12">
						<h2><?php echo $action;?> FAQ Category</h2>
						...
						<form method="post" action="" enctype="multipart/form-data">
							...
							if($count_all > 0) {
								for($i=0;$i<$count_all;$i++) {
									...
									<div class="row">
										<div class="col-lg-12">
											<label><?php echo $vTitleLn;?> Label <i><?php echo ucfirst($required);?></i></label>
										</div>
										<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-12">							
									<input type="submit" class="save btn-info" name="submit" id="submit" value="<?php echo $action;?> FAQ Category">
								</div>
							</div>
						</form>
                	</div>
