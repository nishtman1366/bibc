...
<head>
	<meta charset="UTF-8" />
    <title><?php echo $SITE_NAME?> | FAQ Categories</title>
													...
													if($count_all > 0) {
														for($i=0;$i<$count_all;$i++) {
															...
															<tr class="gradeA">
																...
																<td width="40%"><?php echo $vTitle;?></td>
																<td align="center">
																...
																<td>
																	<a href="faq_categories.php?iUniqueId=<?php echo $iUniqueId;?>&status=<?php echo ($eStatus=="Active")?'Inactive':'Active'?>">
