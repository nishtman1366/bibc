...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | FAQ Category <?php echo $action;?></title>
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?php echo $action;?> دسته بندی پرسش و پاسخ</h2>
						...
						<div class="form-group">
							<?php if($success == 1) { ?>
								<div class="alert alert-success alert-dismissable">
									...
									دسته بندی پرسش و پاسخ با موفقیت ویرایش شد
								</div><br/>
							<?php } ?>
							 <?php if ($success == 2) {?>
							...
							<form method="post" action="" enctype="multipart/form-data">
								...
								<?
									if($count_all > 0) {
										...
										<div class="row">
											<div class="col-lg-12">
												<label><?php echo $vTitleLn;?> برچسب<?php echo $required_msg;?></label>
											</div>
											<div class="col-lg-6">
												<input type="text" class="form-control" name="<?php echo $vTitle;?>"  id="<?php echo $vTitle;?>" value="<?php echo $$vTitle;?>" placeholder="FAQ Category" <?php echo $required;?>>
											</div>
										</div>
										<?php }
									} ?>
									<div class="row faq-but">
										<div class="col-lg-12">
											<input type="submit" class="btn btn-info" name="submit" id="submit" value="<?php echo $action;?> FAQ Category">
										</div>
									</div>
							</form>
						</div>
