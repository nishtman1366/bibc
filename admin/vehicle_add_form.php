...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title><?php echo $SITE_NAME?> |  <?php echo $langage_lbl['LBL_VEHICLE_TXT_ADMIN'];?> <?php echo  $action; ?></title>
						...
						<div class="form-group">
							...
							<form method="post" action="">
								...
								<div class="row">
									...
									<div class="row">
										<div class="col-lg-12">
											<label><?php echo $langage_lbl['LBL_VEHICLE_DRIVER_TXT_ADMIN'];?> <span class="red"> *</span></label>
										</div>
										<div class="col-lg-6">
											<!-- <div id="driver"> -->
							...
							<div class="row">
									 ...
									 <div class="col-lg-6">
										  <div class="make-switch" data-on="success" data-off="warning">
											   <input type="checkbox" name="eStatus" id="eStatus" <?php echo  ($id != '' && $eStatus == 'Inactive') ? '' : 'checked'; ?> />
										  </div>
									 </div>
								</div>
								<div class="row">
									<div class="col-lg-12">
                                        <input type="submit" class="save btn-info" onClick="return chk1();" name="submit" id="submit" value="<?php echo  $action; ?> Driver Taxi" >
									</div>
								</div>
							</form>
						</div>
