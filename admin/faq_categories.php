...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>دسته بندی پرسش و پاسخ | ادمین</title>
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2>دسته بندی پرسش و پاسخ</h2>
							<a href="faq_categories_action.php">
								<input type="button" value="افزودن دسته بندی پرسش و پاسخ" class="add-btn">
							</a>
						</div>
					</div>
					<hr />
															...
															<tr class="gradeA">
																<td width="15%" align="center">
																	<?php if($vImage != '' && file_exists($tconfig['tsite_upload_images_panel'].'/'.$vImage)) { ?>
																		<img src="<?php echo $tconfig['tsite_upload_images'].$vImage;?>" height="50" width="50">
																	<?php } else echo $vImage; ?>
																</td>
																<td><?php echo $vTitle;?></td>
																<td width="15%" align="center">
																	<?php if($iDisplayOrder != 1) { ?>
																		<a href="faq_categories.php?id=<?php echo $iUniqueId;?>&flag=up">
																			<button class="btn btn-warning">
																				<i class="icon-arrow-up"></i>
																			</button>
																		</a>
																		<?php } if($iDisplayOrder != $count_all) { ?>
																		<a href="faq_categories.php?id=<?php echo $iUniqueId;?>&flag=down">
																			<button class="btn btn-warning">
																...
																<td width="20%" class="veh_act">
																	<a href="faq_categories_action.php?id=<?php echo $iUniqueId;?>">
																		<button class="remove_btn001" data-toggle="tooltip" title="Edit FAQ Category">
																			<img src="img/edit-icon.png" alt="Edit">
																		</button>
																	</a>

																	<a href="faq_categories.php?iUniqueId=<?php echo $iUniqueId;?>&status=Active" data-toggle="tooltip" title="Active FAQ Category">
																		<img src="img/active-icon.png" alt="<?php echo $eStatus ?>" >
																	</a>
																	<a href="faq_categories.php?iUniqueId=<?php echo  $iUniqueId; ?>&status=Inactive" data-toggle="tooltip" title="Inactive FAQ Category">
