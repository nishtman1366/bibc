                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <b>Your <?php echo $langage_lbl_admin['LBL_TRIP_TXT_ADMIN']; ?> </b> <?php if ($db_trip[0]['tStartDate'] == "0000-00-00 00:00:00") {
                                    echo "Was Canceled.";
                                } else {
                                    echo @date('h:i A', @strtotime($db_trip[0]['tStartDate'])); ?> on <?php echo @date('d M Y', @strtotime($db_trip[0]['tStartDate']));
                                } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 rider-invoice-new-left">
                                        ...
                                        <?php if ($APP_TYPE != 'UberX') { ?>
                                            ...
                                            <span class="location-to"><i
                                                        class="icon-map-marker"></i> <b><?php echo @date('h:i A', @strtotime($db_trip[0]['tEndDate'])); ?><p><?php echo $db_trip[0]['tDaddress']; ?></p></b></span>
                                        <?php } ?>
                                        ...
                                        <div class="rider-invoice-bottom">
                                            <div class="<?php echo $class_name; ?>">
                                                ...
                                                <b><?php echo $db_vtype[0]['vehcat'] . $db_trip[0]['eCarType']; ?></b><br/>
                                            </div>

                                            <?php if ($APP_TYPE != 'UberX') { ?>

                                                <div class="<?php echo $class_name; ?>">
                                                    Distance<br/> <b><?php echo $db_trip[0]['fDistance']; ?> km</b>
                                                    <br/>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <div class="<?php echo $class_name; ?>">
                                                <?php echo $langage_lbl_admin['LBL_TRIP_TXT_ADMIN']; ?>
                                                time<br/><b><? echo $diff; ?></b>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-sm-6 rider-invoice-new-right">
                                        <h4 style="text-align:center;">    <?php echo $langage_lbl_admin['LBL_FARE_BREAKDOWN_RIDE_NO_TXT']; ?>
                                            :<?php echo $db_trip[0]['vRideNo']; ?></h4>
                                        <hr/>
                                        <table style="width:100%" cellpadding="5" cellspacing="0" border="0">
                                            ...
                                            if ($db_trip[0]['fWalletDebit'] > 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        - <?php echo $generalobj->trip_currency($db_trip[0]['fWalletDebit']); ?> </td>
                                                </tr>
                                                <?
                                            }
                                            ...
                                            if ($db_trip[0]['fDiscount'] > 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        - <?php echo $generalobj->trip_currency($db_trip[0]['fDiscount']); ?> </td>
                                                </tr>
                                                <?
                                            }
                                            ...
                                            <tr>
                                                <td>Commission</td>
                                                <td>
                                                    - <?php echo $generalobj->trip_currency($db_trip[0]['fCommision']); ?></td>
                                            </tr>
                                            <?php
                                            ...
                                            if ($db_trip[0]['fMinFareDiff'] != "" && $db_trip[0]['fMinFareDiff'] > 0) {
                                                ...
                                                <tr>
                                                    <td>
                                                        <b><?php echo $generalobj->trip_currency($minimum_fare); ?></b> <?php echo $langage_lbl_admin['LBL_MINIMUM']; ?>
                                                    </td>
                                            ...
                                            <tr>
                                                <td><b><?php echo $langage_lbl_admin['LBL_Total_Fare_TXT']; ?>
                                                        (Via <?php echo $db_trip[0]['vTripPaymentMode'] ?>)</b></td>
                                                <td>
                                                    <b><?php echo $generalobj->trip_currency($db_trip[0]['iFare']); ?></b>
                                                </td>
                                            </tr>
                                        ...
                                        <div class="invoice-right-bottom-img">
                                            <div class="col-sm-6">
                                                ...
                                                <b><a href="<?php echo $img_path . $db_trip[0]['vBeforeImage']; ?>"
                                                      target="_blank"><img
                                                                src="<?php echo $img_path . $db_trip[0]['vBeforeImage'] ?>"
                                                                style="width:200px;" alt="Before Images"/></b></a>
                                            </div>
                                            <div class="col-sm-6">
                                                <h3><?php echo $langage_lbl_admin['LBL_SERVICE_AFTER_TXT_ADMIN']; ?></h3>
                                                <b><a href="<?php echo $img_path . $db_trip[0]['vBeforeImage']; ?>"
                                                      target="_blank"><img
                                                                src="<?php echo $img_path . $db_trip[0]['vAfterImage']; ?>"
                                                                style="width:200px;" alt="After Images"/></b></a>
                                            </div>
                                    ...
                                    <div class="row invoice-email-but">
                                        ...
                                        <span>
														...
														<a href="../send_invoice_receipt.php?action_from=mail&iTripId=<?php echo $db_trip[0][iTripId] ?>"><button
...
*/
    ...
    jQuery(document).ready(function ($) {
        ...
        var redIcon = L.icon({
            ...
            iconUrl: 'http://maps.gstatic.com/mapfiles/ms2/micons/grn-pushpin.png',
            iconSize: [35, 35], // size of the icon
            shadowSize: [35, 35], // size of the shadow
            iconAnchor: [35, 35], // point of the icon which will correspond to marker's location
            shadowAnchor: [35, 35],  // the same for the shadow
