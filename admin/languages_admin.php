														...
														if($count_all > 0) {
															...
															<tr class="gradeA">
																...
																<td class="center veh_act">
																	<a href="languages_action_admin.php?id=<?php echo $vLabel;?>">
																		<button class="remove_btn001" data-toggle="tooltip" title="Edit Language Label">
																			<img src="img/edit-icon.png" alt="Edit">
																		</button>
																	</a>

																	<!-- <a href="languages_admin.php?id=<?php echo $vLabel;?>&action=delete"><i class="icon-trash"></i> Delete</a>-->
