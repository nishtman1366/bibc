...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
     ...
     <head>
          <meta charset="UTF-8" />
          <title>Admin | <?php echo $langage_lbl_admin['LBL_PET_TYPE'];?>  <?php echo  $action; ?></title>
          ...
          <div id="wrap">
               ...
               <div id="content">
                    <div class="inner">
                         <div class="row">
                              <div class="col-lg-12">
                                   <h2><?php echo  $action; ?> <?php echo $langage_lbl_admin['LBL_USER_PETS_ADMIN'];?> <?php echo  $vTitle; ?></h2>
                              ...
                              <div class="form-group">
                                   ...
                                   <form method="post" action="" enctype="multipart/form-data">
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <select class="form-control" name = 'iUserId' required  id="iUserId" onChange="validate_rider_langcode(this.value)" >
                                                       ...
                                                       <option value = "<?php echo  $db_res_user[$i]['iUserId'] ?>" <?php if($iUserId==$db_res_user[$i]['iUserId']){?>selected<?php }  ?>><?php echo  $db_res_user[$i]['vName'] ?></option>
                                                       <?php } ?>
                                                  </select>
                                             </div>
                                        </div>  
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text"  class="form-control" name=" vTitle"  id="vTitle" value="<?php echo  $vTitle ?>" placeholder="Title" required>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text"  class="form-control" name="vWeight"  id="vWeight" value="<?php echo  $vWeight ?>" placeholder="Weight" required >
                                             </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <input type="submit" class="save btn-info" name="submit" id="submit" value="<?php echo  $action; ?> User Pets"  >
                                             </div>
                                        </div>
                                   </form>
                              </div>
