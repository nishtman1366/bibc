                ...
                <div class="inner">
                    ...
                    <div class="body-div add-booking1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <form name="add_booking_form" id="add_booking_form" method="post" action="area_new.php" enctype="multipart/form-data">
									...
									<span>
										<span>
											<span>
											  <input type="text" title="Enter Area Name." class="form-control add-book-input1" name="sAreaName"  id="sAreaName" value="<?php echo  $sAreaName; ?>" placeholder="نام محدوده" required style="">
											</span>

											<span>
											<input type="text" title="Persian Area Name" class="form-control first-name2" name="sAreaNamePersian"  id="sAreaNamePersian" value="<?php echo  $sAreaNamePersian; ?>" placeholder="نام محدوده به فارسی" required>
											</span>
											<span>
												<?php
											...
											<span>
											<input type="text" class="form-control" name="sPriority"  id="sPriority" value="<?php echo  $sPriority; ?>" placeholder="اولویت" required>
											</span>
											<span>
												<?php
											...
											<?php $btnText = isset($_GET['edit']) ? "Edit Area" : "Add Area" ; ?>
												...
												<input type="reset" class="save btn-info button-submit" name="reset" id="reset12" value="پاک سازی لیست" >
											</span>
											<span>
                            ...
                            <div class="col-lg-7">
								<div class="gmap-div gmap-div1" style="float:right;width:100%;"><div id="app" class="gmap3"></div><input type="button" class="save btn-info button-submit" value="polygon" onclick="polygon2()" ></div>
							</div>
							</div>

							<div class="row">
							<div class="col-lg-7">
								<input type="button" class="save btn-info button-submit" value="بروز رسانی نقشه" onclick="ResetMap()" >
							</div>
							</div>
...
<script type="text/javascript" src="https://cdn.map.ir/web-sdk/1.4.2/js/jquery-3.2.1.min.js"></script>
    ...
    <script type="text/javascript" src="https://cdn.map.ir/web-sdk/1.4.2/js/mapp.min.js"></script>
        ...
        L.cedarmaps.accessToken = '9567524019e7e3259cc8c108f60a8983999c2b0e'; // See the note below on how to get an access token
var app = new Mapp({
        element: '#app',
        presets: {
            latlng: {
    ...
    app.addLayers();
        ...
        var app = L.cedarmaps.map('map', tileJSONUrl, {
...
//console.log(geojsonFeature.features[0].geometry.coordinates[0][0][1]);
	...
	{
			polygonremove();
			dddd=0;markerGroup = L.layerGroup().addTo(map);
...
function appinit() {
  // Initialise the map.
  app = new google.maps.app(document.getElementById('app-canvas'), {
	center: {lat: 35.6899828, lng: 51.389644},
	zoom: 12,
	fullscreenControl: true
  });
  app.data.setControls(['Polygon']); //'Point', 'LineString',
  app.data.setStyle({
	editable: true,
	draggable: true
  });
  ...
  <?php if($appCenter != '') : ?>
	app.setCenter(JSON.parse('<?php echo  $appCenter ?>'));
  <?php endif; ?>
  <?php if($appZoom != '') : ?>
	app.setZoom(<?php echo  $appZoom ?>);
  <?php endif; ?>
