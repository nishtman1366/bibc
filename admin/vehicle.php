...
include_once('../common.php');
	...
	if(checkPermission('VEHICLE') == false)
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
     ...
     <head>
          <meta charset="UTF-8" />
          <title><?php echo $SITE_NAME?> | Vehicles</title>
                                        ...
                                        <form id="<?php echo  $i ?>" method="post" action="" enctype="multipart/form-data">
                                             ...
                                             <div class="box dark image-toggle-box">
                                                  <header class="image-toggle">
                                                       ...
                                                       <h5><?php echo  $db_msk[$i] ?></span></h5>
                                                       <div class="toolbar">
                                                            <ul class="nav">
                                                                 <li>
                                                                      <a href ="vehicle_add_form.php?id=<?php echo  $db_driver_vehicle[$i]['iDriverVehicleId'] ?>" class="btn btn-danger">
                                                                           <i class="icon-pencil icon-white"></i>  Edit
                                                                      </a>
                                                                 </li>
                                                                 <li>
                                                                           <a class="btn btn-danger" onClick="confirm_delete('<?php echo  $db_driver_vehicle[$i]['iDriverVehicleId'] ?>');">
                                                                                <i class="icon-remove icon-white"></i> Delete
                                                                           </a>
                                                                 </li>     
                                                                 <li>
                                                                      <a class="accordion-toggle minimize-box" data-toggle="collapse" href="#div-<?php echo  $i; ?>">
                                                  ...
                                                  <div id="div-<?php echo  $i; ?>" class="tabing-inner-pageaccordion-body collapse <?php echo  ($i == 0) ? 'in' : 'out'; ?> ">
                                                       <div class="documents">
                                                            <div class="row">
                                                                 <div class="col-sm-12">
                                                                      <h3>DOCUMENTS</h3>
                                                                                     ...
                                                                                     <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                                                                                          ...
                                                                                          <?php $file_ext = $generalobj->file_ext($db_driver_vehicle[$i]['vInsurance']);
                                                                                                    if($file_ext == 'is_image'){ ?>
                                                                                                              <img src = "<?php echo  $tconfig["tsite_upload_vehicle_doc_panel"] . '/' .$db_driver_vehicle[$i]['vInsurance'] ?>" style="width:200px;" alt ="Insurance Image"/>
                                                                                                    <?php }else{ ?>
                                                                                                               <a href="<?php echo  $tconfig["tsite_upload_vehicle_doc_panel"] . '/' . $db_driver_vehicle[$i]['vInsurance']  ?>" target="_blank">Insurance Doc</a> 
                                                                                                    <?php } ?>
                                                                                ...
                                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                     <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                                                                                          ...
                                                                                          <?php $file_ext = $generalobj->file_ext($db_driver_vehicle[$i]['vPermit']);
                                                                                                    if($file_ext == 'is_image'){ ?>
                                                                                                              <img src = "<?php echo  $tconfig["tsite_upload_vehicle_doc_panel"] . '/' .$db_driver_vehicle[$i]['vPermit'] ?>" style="width:200px;" alt ="Insurance Image"/>
                                                                                                    <?php }else{ ?>
                                                                                                               <a href="<?php echo  $tconfig["tsite_upload_vehicle_doc_panel"] . '/' . $db_driver_vehicle[$i]['vPermit']  ?>" target="_blank">Insurance Doc</a> 
                                                                                                    <?php } ?>
                                                                                          <?php } else { ?> Permit
                                                                                          <?php } ?></div>
                                                                                     <div>
                                                                                ...
                                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                     <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px; ">
                                                                                          ...
                                                                                          <?php $file_ext = $generalobj->file_ext($db_driver_vehicle[$i]['vRegisteration']);
                                                                                                    if($file_ext == 'is_image'){ ?>
                                                                                                              <img src = "<?php echo  $tconfig["tsite_upload_vehicle_doc_panel"] . '/' .$db_driver_vehicle[$i]['vRegisteration'] ?>" style="width:200px;" alt ="Insurance Image"/>
                                                                                                    <?php }else{ ?>
                                                                                                               <a href="<?php echo  $tconfig["tsite_upload_vehicle_doc_panel"] . '/' . $db_driver_vehicle[$i]['vRegisteration']  ?>" target="_blank">Insurance Doc</a> 
                                                                                                    <?php } ?>          
