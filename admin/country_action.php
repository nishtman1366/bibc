...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | Country <?php echo $action;?></title>
					...
					<div class="body-div">
						<div class="form-group">
							...
							<form method="post" action="">
								...
								<div class="row">
									<div class="col-lg-12">
										<label>نام کشور<span class="red"> *</span></label>
									</div>
									<div class="col-lg-6">
										<input type="text" class="form-control" name="vCountry"  id="vCountry" value="<?php echo $vCountry;?>" placeholder="Country Name" required>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<label>کد کشور<span class="red"> *</span></label>
									</div>
									<div class="col-lg-6">
										<input type="text" class="form-control" name="vCountryCode"  id="vCountryCode" value="<?php echo $vCountryCode;?>" placeholder="Country Code" required>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<label>کد کشور ISO_3<span class="red"> *</span></label>
									</div>
									<div class="col-lg-6">
								...
								<div class="row">
									<div class="col-lg-12">
										<label>کد شماره تلفن کشور<span class="red"> *</span></label>
									</div>
									<div class="col-lg-6">
								...
								<div class="row">
									<div class="col-lg-12">
										<input type="submit" class="save btn-info" name="submit" id="submit" value="<?php echo $action;?> Country">
									</div>
								</div>
							</form>
						</div>
