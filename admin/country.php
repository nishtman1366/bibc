					...
					<div class="row">
						<div class="col-lg-12">
							...
							<a href="country_action.php">
								<input type="button" value="افزودن کشور" class="add-btn">
							</a>
						</div>
					</div>
				<?php if ($success == 2) { ?>
												...
												<tbody>
													<?
														...
														if($count_all > 0) {
															...
															?>
															<tr class="gradeA">
																<td width="40%"><?php echo $vCountry;?></td>
																<td width="20%"><?php echo $vPhoneCode;?></td>
																...
																<td class="center veh_act" width="20%">
																	<a href="country_action.php?id=<?php echo $id;?>">
																		<button class="remove_btn001" data-toggle="tooltip" title="Edit Country">
																			<img src="img/edit-icon.png" alt="Edit">
																		</button>
																	</a>

																	<a href="country.php?iCountryId=<?php echo $id;?>&status=Active" data-toggle="tooltip" title="Active Country">
																		<img src="img/active-icon.png" alt="<?php echo $eStatus ?>" >
																	</a>
																	<a href="country.php?iCountryId=<?php echo  $id; ?>&status=Inactive" data-toggle="tooltip" title="Inactive Country">
