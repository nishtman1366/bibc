                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            ...
                                                            <tbody>
                                                                 ...
                                                                 <tr class="gradeA">
                                                                      ...
                                                                      <td><?php echo  $data_drv[$i]['vWeight']; ?></td>                     
                                                                      <td><?php echo  $data_drv[$i]['tBreed']; ?></td>                     
                                                                                                                                     
                                                                      <td>
                                                                           <a href="user_pets_action.php?id=<?php echo  $data_drv[$i]['iUserPetId']; ?>" style="float: left;">
                                                                        ...
                                                                        <td>     
                                                                           <form name="delete_form" id="delete_form" method="post" action="" onSubmit="return confirm('Are you sure you want to delete record?')" class="margin0">
                                                                                <input type="hidden" name="hdn_del_id" id="hdn_del_id" value="<?php echo  $data_drv[$i]['iUserPetId']; ?>">
