        ...
        <div class="inner">
            <div id="add-hide-show-div">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a class="add-btn" href="package_type_action.php" style="text-align: center;">افزودن نوع
                            بسته</a>
            ...
            <?php if ($success == 1) { ?>
                <div class="alert alert-success alert-dismissable">
                    ...
                    <?php } else if ($ksuccess == "2") {
                        ?>
                        نوع بسته با موفقیت ویرایش شد
                    <?php } else if ($ksuccess == "3") {
                        ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <?php for ($i = 0; $i < count($data_pckg); $i++) { ?>
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                    <a href="package_type_action.php?id=<?php echo $data_pckg[$i]['iPackageTypeId']; ?>"
                                                       style="float: left;">
                                                ...
                                                <td>
                                                    <form name="delete_form" id="delete_form" method="post" action=""
                                                        ...
                                                        <input type="hidden" name="hdn_del_id" id="hdn_del_id"
                                                               value="<?php echo $data_pckg[$i]['iPackageTypeId']; ?>">
