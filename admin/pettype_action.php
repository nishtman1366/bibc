          ...
          <div id="wrap">
               ...
               <div id="content">
                    <div class="inner">
                         <div class="row">
                              <div class="col-lg-12">
                                   <h2><?php echo  $action; ?> <?php echo $langage_lbl_admin['LBL_PET_TYPE'];?><?php echo  $vTitle_EN; ?></h2>
                                   <a href="pettype.php">
                              ...
                              <div class="form-group">
                                   ...
                                   <form method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <?
                                        ...
                                        <div class="row">
                                             <div class="col-lg-12">
                                             <label>Title (<?php echo $vTitle;?>) <span class="red"> *</span></label>
                                        ...
                                        <!--<div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text"  class="form-control" name="vTitle_ES"  id="vTitle_ES" value="<?php echo  $vTitle_ES ?>" placeholder="Title Spanish" required >
                                             </div>
                                        </div>-->
                                        ...
                                        <div class="row">
                                             <div class="col-lg-12">
                                                  <input type="submit" class="save btn-info" name="submit" id="submit" value="<?php echo  $action; ?> Pet Type"  >
                                             </div>
                                        </div>
                                   </form>
                              </div>
