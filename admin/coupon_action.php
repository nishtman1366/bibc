      ...
      <div class="body-div">
        <div class="form-group"> <span style="color: red;font-size: small;" id="coupon_status"></span>
          ...
          <div class="alert alert-success alert-dismissable">
            ...
            کد تخفیف با موفقیت ویرایش شد </div>
          <br/>
          <?} ?>
          <?php if ($success == 2) {?>
          ...
          <div class="alert alert-danger alert-dismissable">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">x</button>
            "مقدار درصد بین 1 تا 100 باید باشد </div>
          <br/>
          <?} ?>
          <form method="post" action="" enctype="multipart/form-data" class="">
            ...
            <div class="row coupon-action-n1">
              ...
              <div class="col-lg-6">
                <input type="text" class="form-control" name="vCouponCode" onBlur=" validate_coupon(this.value)"  id="vCouponCode" value="<?php echo  $vCouponCode; ?>" placeholder="Coupon Code" required>
                <a style="margin: 0 !important;" class="btn btn-sm btn-info" onClick="randomStringToInput(this)">تولید کد کوپن</a> </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <textarea name="tDescription" rows="5" cols="40" class="form-control" id="tDescription" placeholder="Description" required><?php echo $tDescription;?>
</textarea>
              </div>
            </div>
            <div class="row coupon-action-n2">
              ...
              <div class="col-lg-6">
                <input type="number" class="form-control" name="fDiscount" min="0"  id="fDiscount" value="<?php echo  $fDiscount; ?>" placeholder="Discount" required>
            ...
            <div class="row" id="date1" style="display:none;">
              ...
              <div class="col-lg-6">
                <input type="text" style="float: left;margin-right: 10px; width:45% " class="form-control" name="dActiveDate"  id="dActiveDate" value="<?php echo  $dActiveDate ?>" placeholder="Activation Date" >
              </div>
            </div>
            <div class="row" id="date2" style="display:none;">
              ...
              <div class="col-lg-6">
                <input type="text" style="float: left;margin-right: 10px; width:45% " class="form-control" name="dExpiryDate" value="<?php echo  $dExpiryDate ?>"  id="dExpiryDate" placeholder="Expiry Date">
              </div>
            </div>
            <div class="row coupon-action-n3">
              ...
              <div class="col-lg-6">
                <input type="number" min="0" id="iUsageLimit" value="<?php echo  $iUsageLimit ?>"  name="iUsageLimit"  title="Usage Limit" class="form-control"/>
              </div>
            </div>
            <div class="row coupon-action-n3">
              <div class="col-lg-12">
              ...
              <div class="col-lg-6">
                <select id="eStatus" name="eStatus" class="form-control ">
                  <option value="Active" <?php if($db_data[0]['eStatus'] == "Active"){ ?>selected <?php } ?> >فعال</option>
                  <option value="Inactive" <?php if($db_data[0]['eStatus'] == "Inactive"){?>selected <?php } ?> >غیر فعال</option>
                </select>
              </div>
            </div>
              ...
              <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="make-switch" data-on="success" data-off="warning">
                            <input type="checkbox" class="chk" name="eOnePerUser" <?php if($eOnePerUser == 'Yes'){?>checked<?php } ?> value="Yes"/>
                        </div>
                    </div>
                </div>
              ...
              <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="make-switch" data-on="success" data-off="warning">
                            <input type="checkbox" class="chk" name="eForFirstTrip" <?php if($eForFirstTrip == 'Yes'){?>checked<?php } ?> value="Yes"/>
                        </div>
                    </div>
                </div>
            ...
            <div class="row coupon-action-n4">
              <div class="col-lg-12">
                <input type="submit" class="save btn-info" name="submit" id="submit" value="<?php echo  $action; ?> PromoCode"  >
              </div>
            </div>
          </form>
        </div>
