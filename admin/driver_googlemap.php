							...
							<div class="col-lg-12">
								<div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <input class="form-control" type="text" id="searchDriver" name="searchDriver"  style="width:18%;display:table-row-group;" placeholder="Driver" autocomplete="off" value="<?php echo  $searchDriver ?>">
                                                    
                                        <input type="hidden" id="iDriverId" name="iDriverId" value="<?php echo  $iDriverId ?>">
                                        <button type="button" id="btnShowDriver" class="btn btn-default btn-sm">Show</button>
