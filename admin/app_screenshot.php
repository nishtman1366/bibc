		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2>اسکرین شات از صفحات برنامه</h2>
							<a href="appscreenshot_action.php">
								<input type="button" value="افزودن اسکرین شات" class="add-btn">
							</a>
						</div>
					</div>
					<hr />
												...
												<tbody>
													...
													if(!empty($db_data)){
														...
														foreach($db_data as $value){
															...
															?>
															<tr class="gradeA">
																<td width="40%" ><?php echo $vImageTitle;?></td>
																...
																<td width="25%" align="center" class="veh_act">
																	<a href="appscreenshot_action.php?id=<?php echo $iId;?>">
																		<button class="remove_btn001" data-toggle="tooltip" title="Edit App Screenshot">
																			<img src="img/edit-icon.png" alt="Edit">
																		</button>
																	</a>

																	<a href="app_screenshot.php?id=<?php echo $iId;?>&status=Active" data-toggle="tooltip" title="Active App Screenshot">
																		<img src="img/active-icon.png" alt="<?php echo $eStatus ?>" >
																	</a>
																	<a href="app_screenshot.php?id=<?php echo  $iId; ?>&status=Inactive" data-toggle="tooltip" title="Inactive App Screenshot">
																	...
																	<form name="delete_form" id="delete_frm" method="post" action="" onSubmit="return confirm_delete()" class="margin0">
																		<input type="hidden" name="hdn_del_id" id="hdn_del_id" value="<?php echo $iId;?>">
