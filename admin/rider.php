				...
				<div class="inner">
					<div id="add-hide-show-div">
						<div class="row">
							<div class="col-lg-12">
								<h2>سوار / پیک</h2>
								<a href="rider_action.php"><input type="button" id="show-add-form" value="افزودن سوار" class="add-btn"></a>
							...
							<div class="col-lg-12">
								<div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <input class="form-control" type="text" id="searchPassenger" name="searchPassenger" style="width:18%;display:table-row-group;" placeholder="Passenger" value="<?php echo  $searchPassenger ?>">
														...
														<tr class="gradeA">
															...
															<td  class="veh_act"  align="center" style="text-align:center;">
																<?php if($data_drv[$i]['eStatus']!="Deleted"){?>
																	<a href="rider_action.php?id=<?php echo  $data_drv[$i]['iUserId']; ?>" data-toggle="tooltip" title="Edit Rider">
																		<img src="img/edit-icon.png" alt="Edit">
																	</a>
																<?php }?>

																<a href="rider.php?iUserId=<?php echo  $data_drv[$i]['iUserId']; ?>&status=Active" data-toggle="tooltip" title="Active Rider">
																	<img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
																</a>
																<a href="rider.php?iUserId=<?php echo  $data_drv[$i]['iUserId']; ?>&status=Inactive" data-toggle="tooltip" title="Inactive Rider">
																	<img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
																</a>
																<?php if($data_drv[$i]['eStatus']!="Deleted"){?>
																	<form name="delete_form" id="delete_form" method="post" action="" onSubmit="return confirm_delete()" class="margin0">
																		<input type="hidden" name="hdn_del_id" id="hdn_del_id" value="<?php echo  $data_drv[$i]['iUserId']; ?>">
																		<input type="hidden" name="action" id="action" value="delete">
																		<button class="remove_btn001" data-toggle="tooltip" title="Delete Rider">
																			<img src="img/delete-icon.png" alt="Delete">
																		</button>
																	</form>

																	<form name="reset_form" id="reset_form" method="post" action="" onSubmit="return confirm('Are you sure?you want to reset <?php echo  $data_drv[$i]['vName'].' '.$data_drv[$i]['vLastName'];?> account?')" class="margin0">
																		<input type="hidden" name="res_id" id="res_id" value="<?php echo  $data_drv[$i]['iUserId']; ?>">
