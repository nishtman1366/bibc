					...
					<div class="row">
						<div class="col-lg-12">
							...
							<a href="banner_action.php">
								<input type="button" value="افزودن بنر" class="add-btn">
							</a>
						</div>
					</div>
					<hr />
															...
															<tr class="gradeA">
																...
																<td width="10%" align="center">
																	<?php if($iDisplayOrder != 1) { ?>
																		<a href="banner.php?id=<?php echo $iUniqueId;?>&flag=up">
																			<button class="btn btn-warning">
																				<i class="icon-arrow-up"></i>
																			</button>
																		</a>
																		<?php } if($iDisplayOrder != $count_all) { ?>
																		<a href="banner.php?id=<?php echo $iUniqueId;?>&flag=down">
																			<button class="btn btn-warning">
																...
																<td width="10%" align="center">
																	<a href="banner.php?iUniqueId=<?php echo $iUniqueId;?>&status=<?php echo ($eStatus=="Active")?'Inactive':'Active'?>">
																...
																<td width="10%" align="center">
																	<a href="banner_action.php?id=<?php echo $iUniqueId;?>">
