                ...
                <div class="form-group"><span style="color: red;font-size: small;" id="coupon_status"></span>
                    ...
                    <form method="post" action="" enctype="multipart/form-data" class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <textarea name="message_body" rows="5" cols="40" class="form-control" id="message_body"
                        ...
                        <div class="row coupon-action-n6">
                            ...
                            <div class="col-lg-6">
                                <?php if (!empty($db_drivers2)) { ?>
                                    <span><select class="form-control form-control-select" name='riciver_type_driver'
                                                  id="iGcmRegId">
