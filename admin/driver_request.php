...
if ($iCompanyId != '' && $status != '') {
    if (SITE_TYPE != 'Demo') {
        ...
        header("Location:company.php?success=1&var_msg=" . $var_msg);
        exit;
    } else {
            ...
            <div style="margin: 13px;margin-top: -6px;">
                ...
                <form name="search" action="" method="post" onSubmit="return checkvalid()">
                    <div class="Posted-date mytrip-page">
                        ...
                        <span>
                        <input type="date" id="dp4" name="startDate" placeholder="از تاریخ" class="form-control"
                               value="" style="cursor:default; background-color: #fff"/>
                        <input type="date" id="dp5" name="endDate" placeholder="تا تاریخ" class="form-control" value=""
                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <? for ($i = 0; $i < count($data_drv); $i++) {
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                ?>
                                                <td>
                                                    <a href="invoice.php?iTripId=<?php echo $data_drv[$i]['iMsgCode']; ?>"
                                                       target="_blank"><?php echo $data_drv[$i]['iMsgCode']; ?></a>
                                                </td>
                                                ...
                                                <td class="center" width="12%" align="center"
