                ...
                <div class="inner">
                    ...
                    <div class="body-div add-booking1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
								<div class="gmap-div gmap-div1" style="float:right;width:100%;"><div id="map" class="gmap3"></div><input type="button" class="save btn-info button-submit" value="polygon" onclick="polygon2()" ></div>
							</div>
							</div>
