...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | General <?php echo  $action; ?></title>
						...
						<div class="form-group">
							...
							<form method="post" action="" enctype="multipart/form-data">
							 ...
							 <div class="row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="vName"  id="vName" value="<?php echo $vName;?>" placeholder="Last Name" required readonly >
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<label><?php echo $tDescription;?><span class="red"> *</span></label>
									</div>
									...
									<div class="col-lg-6">
										<?php
											if($vName=='APP_IMG'){
												?>
										<input type="file" class="form-control" name="vValue"  id="vValue" value="<?php echo  $vValue; ?>" placeholder="First Name" required>
										<?
											}else if($vName=='FACEBOOK_IFRAME')
											{?>
										<textarea class="form-control" name="vValue"  id="vValue" cols="" rows="8"><?php echo  $vValue; ?></textarea>
										<?}
												else{
													?>
										<input type="text" class="form-control" name="vValue"  id="vValue" value="<?php echo  $vValue; ?>" placeholder="" required>
										<?		}
											?>
									</div>
								</div>
								...
								<!-- <div class="row">
									...
									<div class="col-lg-6">
										<input type="hidden" class="form-control" name="tDescription"  id="tDescription" value="<?php echo $tDescription;?>" placeholder="Last Name" required>
									</div>
								</div>-->
