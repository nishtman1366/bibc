...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | App Screen Short Page <?php echo $action;?></title>
		...
		<div id="wrap">
			...
			<div id="content">
				<div class="inner">
					<div class="row">
						<div class="col-lg-12">
							<h2><?php echo $action;?>  اسکرین شات صفحات نرم افزار</h2>
						...
						<div class="form-group">
							<?php if($success == 1) { ?>
								<div class="alert alert-success alert-dismissable">
									...
									اسکرین شات صفحات نرم افزار با موفقیت ویرایش شد
								</div><br/>
							...
							<form method="post" action=""  enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" name="vImageTitle" value="<?php echo $vImageTitle;?>" placeholder="Screen Titile" required >
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<label>بارگذاری اسکرین شات</label>
									</div>
									<div class="col-lg-6">
										<?php if($vImageName != '') { ?>
											<a target="_blank" href="<?php echo $tconfig['tsite_upload_apppage_images_panel'].$vImageName;?>"><img src="<?php echo $tconfig['tsite_upload_apppage_images_panel'].$vImageName;?>" style="width:200px;height:100px;"></a>
										<?php } ?>
								...
								<div class="row">
									<div class="col-lg-12">
										  <label>نمایش سفارش<span class="red"> *</span></label>
									</div>
									<div class="col-lg-6">
											...
											<?php
												...
												if(!empty($db_Of_data)){
													...
													for($i=0;$i<=count($db_Of_data);$i++){ ?>
														...
														<option value="<?php echo $i+1;?>" <?php if($iDescOrd ==$i+1){?> selected <?php }?>><?php echo $i+1?></option>
								...
								<div class="row">
										<div class="col-lg-12">
											<input type="submit" class="save btn-info" name="btnsubmit" id="btnsubmit" value="<?php echo $action;?> Image">
										</div>
								</div>
							</form>
						</div>
