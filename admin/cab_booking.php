                                        ...
                                        <?php for ($i = 0; $i < count($data_drv); $i++) { ?>
                                            <tr class="gradeA">
                                                ...
                                                <td style="direction: rtl;" width="10%"
                                                    data-order="<?php echo $data_drv[$i]['iCabBookingId']; ?>"><?php echo jdate('dS M Y,', strtotime($data_drv[$i]['dBooking_date'])); ?><?php echo jdate('H:i', strtotime($data_drv[$i]['dBooking_date'])); ?></td>
                                                ...
                                                <?php if ($data_drv[$i]['eAutoAssign'] == "Yes") { ?>
                                                    <td width="10%">راننده خودکار اختصاص داشته شده است<a
                                                                class="btn btn-info"
                                                                href="add_booking.php?booking_id=<?php echo $data_drv[$i]['iCabBookingId']; ?>"
                                                                data-tooltip="tooltip" title="Edit"><i
                                                                    class="icon-edit icon-flip-horizontal icon-white"></i></a><br>(
                                                        نوع ماشین : <?php echo $data_drv[$i]['vVehicleType']; ?>)
                                                    </td>
                                                <?php } else if ($data_drv[$i]['eStatus'] == "Pending") { ?>
                                                    <td width="10%"><a class="btn btn-info"
                                                                       href="add_booking.php?booking_id=<?php echo $data_drv[$i]['iCabBookingId']; ?>"><i
                                                ...
                                                <?php } else if ($data_drv[$i]['driver'] != "" && $data_drv[$i]['driver'] != "0") { ?>
                                                    <td width="10%"><b><?php echo $data_drv[$i]['driver']; ?></b><br>(
                                                        نوع ماشین : <?php echo $data_drv[$i]['vVehicleType']; ?>)
                                                    </td>
                                                <?php } else { ?>
                                                ...
                                                <td width="10%"><?php if ($data_drv[$i]['iTripId'] != "" && $data_drv[$i]['eStatus'] == "Completed") { ?>
                                                        <a class="btn btn-primary" href="javascript:void(0);"
                                                           onclick='javascript:window.open("invoice.php?iTripId=<?php echo $data_drv[$i]['iTripId'] ?>","_blank")'
                                                           ;>نمایش</a>
                                                    <?php } else {
                                                        echo "---";
                                                    } ?>
                                                ...
                                                <td width="15%">
                                                    ...
                                                    if ($data_drv[$i]['eStatus'] == "Cancel") {
                                                        ...
                                                        <br/><a href="javascript:void(0);" class="btn btn-info"
                                                                data-toggle="modal"
                                                                data-target="#uiModal_<?php echo $data_drv[$i]['iCabBookingId']; ?>">Cancel
                                                            Reason</a>
                                                        <?
                                                    }
                                                    ?>
                                            ...
                                            <div class="modal fade"
                                                 id="uiModal_<?php echo $data_drv[$i]['iCabBookingId']; ?>"
                                                ...
                                                <div class="modal-content image-upload-1" style="width:400px;">
                                                    <div class="upload-content" style="width:350px; padding:0px;">
                                                        <h3>دلیل لغو رزرو</h3>
                                                        <h4>کنسل شده
                                                            توسط: <?php echo $data_drv[$i]['eCancelBy']; ?></h4>
