...
if (checkPermission('COUPON') == false)
...
if ($iCouponId != '' && $eStatus != '') {
    if (SITE_TYPE != 'Demo') {
        ...
        header("Location:coupon.php?success=2");
        exit;
    }
}
        ...
        <div class="inner">
            <div id="add-hide-show-div">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a class="add-btn" href="coupon_action.php" style="text-align: center;">افزودن کد تخفیف</a>
            ...
            <?php if ($_GET['success'] == 1) { ?>
                <div class="alert alert-success alert-dismissable msgs_hide">
                    ...
                    کد تخفیف با موفقیت بروز رسانی شد
                </div><br/>
                    ...
                    <div class="page-form">
                        ...
                        <ul>
                            <li>
                                ...
                                <input type="text" id="vCouponCode" name="vCouponCode" class="inputbox"
                                       title="Gift/Certificate Code" required placeholder="Gift/Certificate Code"/>

                            </li>
                            <li>
                                Discount * :<br>
                                <input type="text" id="fDiscount" name="fDiscount" class="inputbox" title="Discount"
                                       required placeholder="Discount"/>
                                <select id="eType" name="eType">
                                    <option value="%" <?php if ($db_coupon[0]['eType'] == "%") { ?> selected <?php } ?> >
                                        %
                                    </option>
                                    <option value="cash"
                                            <?php if ($db_coupon[0]['eType'] == "cash"){ ?>selected <?php } ?> >$
                                    </option>
                                </select>
                            </li>
                            <li>
                                ...
                                <input type="radio" name="eValidityType" onclick="showhidedate(this.value)"
                                       value="Permanent" <?php if ($db_coupon[0]['eValidityType'] == 'Permanent') { ?> checked <?php } else { ?> checked <?php } ?> >
                                Permanent
                                <input type="radio" name="eValidityType" onClick="showhidedate(this.value)"
                                       value="Defined" <?php if ($db_coupon[0]['eValidityType'] == 'Defined') { ?> checked <?php } ?> >Defined


                            </li>
                            <li>
                                Activation Date :<br>
                                <input type="text" Readonly id="dActiveDate" name="dActiveDate" style="width:100px;"
                                       class="inputbox" value="<?php echo $db_coupon[0]['dActiveDate']; ?>"
                                       title="Activation Date"/>
                            </li>
                            <li>
                                Expiry Date:<br>
                                <input type="text" Readonly id="dExpiryDate" name="dExpiryDate" style="width:100px;"
                                       class="inputbox" value="<?php echo $db_coupon[0]['dExpiryDate']; ?>"
                                       title="Expiry Date"/>
                            </li>
                            <li>
                                Usage Limit :<br>
                                <input type="text" id="iUsageLimit" name="iUsageLimit" class="inputbox"
                                       value="<?php echo $db_coupon[0]['iUsageLimit']; ?>" title="Usage Limit"/>
                            </li>
                            <li>
                                Status :<br>
                                <select id="eStatus" name="eStatus">
                                    <option value="Active"
                                            <?php if ($db_coupon[0]['eStatus'] == "Active"){ ?>selected <?php } ?> >
                                        Active
                                    </option>
                                    <option value="Inactive"
                                            <?php if ($db_coupon[0]['eStatus'] == "Inactive"){ ?>selected <?php } ?> >
                                        Inactive
                                    </option>
                                </select>
                            </li>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <?php for ($i = 0; $i < count($db_coupon); $i++) { ?>
                                            <tr class="gradeA">
                                                <td><?php echo $db_coupon[$i]['vCouponCode']; ?></td>
                                                <?php if ($db_coupon[$i]['eType'] == "percentage") {
                                                    $e_value = "%";
                                                } else {
                                                    $e_value = "$";
                                                } ?>
                                                <td><?php echo $db_coupon[$i]['fDiscount'] . " " . $e_value; ?></td>

                                                <td><?php echo $db_coupon[$i]['eValidityType']; ?></td>
                                                <?php if ($db_coupon[$i]['dActiveDate'] == "00/00/0000") { ?>
                                                    <td style="text-align:center;">---</td>
                                                <?php } else { ?>
                                                    <td><?php echo $db_coupon[$i]['dActiveDate']; ?></td>
                                                <? } ?>
                                                <?php if ($db_coupon[$i]['dExpiryDate'] == "00/00/0000") { ?>
                                                    <td style="text-align:center;">---</td>
                                                <?php } else { ?>
                                                    <td><?php echo $db_coupon[$i]['dExpiryDate']; ?></td>
                                                <?php } ?>
                                                <td><?php echo $db_coupon[$i]['iUsageLimit']; ?></td>
                                                <td><?php echo $db_coupon[$i]['iUsed']; ?></td>
                                                ...
                                                <td width="10%" align="center">
                                                    ...
                                                    <img src="<?php echo $dis_img; ?>"
                                                         alt="<?php echo $db_coupon[$i]['eStatus'] ?>">
                                                </td>
                                                <td class="veh_act" align="center" style="text-align:center;">
                                                    <a href="coupon_action.php?iCouponId=<?php echo $db_coupon[$i]['iCouponId']; ?>"
                                                       data-toggle="tooltip" title="Edit Coupon">
                                                        <img src="img/edit-icon.png" alt="Edit">
                                                    </a>

                                                    <a href="coupon.php?iCouponId=<?php echo $db_coupon[$i]['iCouponId']; ?>&eStatus=Active"
                                                       data-toggle="tooltip" title="Active Coupon">
                                                        <img src="img/active-icon.png"
                                                             alt="<?php echo $data_drv[$i]['eStatus']; ?>">
                                                    </a>

                                                    <a href="coupon.php?iCouponId=<?php echo $db_coupon[$i]['iCouponId']; ?>&eStatus=Inactive"
                                                       data-toggle="tooltip" title="Inactive Coupon">
                                                    ...
                                                    <form name="delete_form" id="delete_form" method="post" action=""
                                                        ...
                                                        <input type="hidden" name="iCouponId" id="iCouponId"
                                                               value="<?php echo $db_coupon[$i]['iCouponId']; ?>">
