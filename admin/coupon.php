                                                            ...
                                                            <tbody>
                                                                 ...
                                                                 <tr class="gradeA">
																	  ...
																	  <td width="10%" align="center">
																		...
																		<img src="<?php echo $dis_img;?>" alt="<?php echo $db_coupon[$i]['eStatus']?>">
                                                                      </td>
                                                                      <td class="veh_act" align="center" style="text-align:center;">
                                                                           <a href="coupon_action.php?iCouponId=<?php echo  $db_coupon[$i]['iCouponId']; ?>" data-toggle="tooltip" title="Edit Coupon">
                                                                                <img src="img/edit-icon.png" alt="Edit">
                                                                           </a>

																	<a href="coupon.php?iCouponId=<?php echo  $db_coupon[$i]['iCouponId']; ?>&eStatus=Active" data-toggle="tooltip" title="Active Coupon">
																		<img src="img/active-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
																	</a>

																	<a href="coupon.php?iCouponId=<?php echo  $db_coupon[$i]['iCouponId']; ?>&eStatus=Inactive" data-toggle="tooltip" title="Inactive Coupon">
																		<img src="img/inactive-icon.png" alt="<?php echo $data_drv[$i]['eStatus']; ?>" >
																	</a>
                                                                           <form name="delete_form" id="delete_form" method="post" action="" onSubmit="return confirm_delete()" class="margin0">
                                                                                <input type="hidden" name="iCouponId" id="iCouponId" value="<?php echo  $db_coupon[$i]['iCouponId']; ?>">
