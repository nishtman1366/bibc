                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="dataTables-example">
															...
															<?php 
																 ...
																 for($i=0;$i<count($result_driver);$i++){ ?>										 
																	 ...
																	 <tr class="gradeA">
																		<td ><?php echo $result_driver[$i]['vName'];?> <?php echo  $result_driver[$i]['vLastName'];?></td>
																		<?php 
																			$time = strtotime($result_driver[$i]['dRefDate']);
																			$myFormatForView = date("jS F Y", $time);																	 
																		?>
																		<td><?php echo  $myFormatForView ?></td>
																		<!--<td>$ <?php echo $result_driver[$i]['iBalance']?></td> -->
																	 </tr>																 
                                                       ...
                                                       <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            ...
                                                            <tbody>                                                                 
																 ...
																 for($i=0;$i<count($result_rider);$i++){ ?>										 
																	 ...
																	 <tr class="gradeA">
																		<td><?php echo  $result_rider[$i]['vName'];?> <?php echo  $result_rider[$i]['vLastName'];?></td>
																		<?php 
																			$time = strtotime($result_rider[$i]['dRefDate']);
																			$myFormatForView = date("jS F Y", $time);																	 
																		?>
																		<td><?php echo  $myFormatForView ?></td>
																		<!--<td>$ <?php echo $result_rider[$i]['iBalance']?></td> -->
																	 </tr>																 
