...
<head>
	<meta charset="UTF-8" />
    <title><?php echo $SITE_NAME?> | Model <?php echo $action;?></title>
					...
					<div class="form-group">
						...
						<form method="post" action="">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<input type="text" class="form-control" name="vTitle"  id="vTitle" value="<?php echo $vTitle;?>" placeholder="Model Label" required>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-12">
