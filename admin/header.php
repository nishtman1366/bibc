...
$showtables = mysqli_query($condbc, "SHOW TABLES FROM k68ir_DB");
...
<div id="top">
    <nav class="navbar navbar-inverse navbar-fixed-top" style="padding:7px 0;">
        <a data-original-title="Show/Hide Menu" data-placement="bottom" data-tooltip="tooltip"
           ...
           id="menu-toggle"><i class="icon-align-justify"></i></a>
        <!-- LOGO SECTION -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <span class="label label-success"></span><i class="icon-envelope-alt"></i>&nbsp; <i
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <!-- <span class="label label-danger"></span> --> <i class="icon-tasks"></i>&nbsp; <i
                            class="icon-chevron-down"></i>
                </a>
                            ...
                            <div>
                                ...
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40"
                                         aria-valuemin="0" aria-valuemax="100" style="width: <? echo $ComAct . "%"; ?>">
                            ...
                            <div>
                                ...
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="60"
                                         aria-valuemin="0" aria-valuemax="100"
                                         style="width:<?php echo $VehicleAct . "%"; ?>">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="admin_action.php?id=<? echo $_SESSION['sess_iAdminUserId']; ?>"><i
                                    class="icon-user"></i> User Profile </a></li>
