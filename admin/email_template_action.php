...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
	...
	<head>
		<meta charset="UTF-8" />
		<title>Admin | Email Template <?php echo $action;?></title>
					...
					<div class="body-div">
						<div class="form-group">
							...
							<form method="post" action=""  enctype="multipart/form-data">
								...
								<input type="hidden" name="vEmail_Code" id="vEmail_Code" value="<?php echo $vEmail_Code;?>">
								...
								<?
									if($count_all > 0) {
										...
										<div class="row">
											<div class="col-lg-12">
												<label><?php echo $vLTitle;?> Subject <?php echo $required_msg;?></label>
											</div>
											<div class="col-lg-6">
												<input type="text" class="form-control" name="<?php echo $vSubject;?>"  id="<?php echo $vSubject;?>" value="<?php echo $$vSubject;?>" placeholder="<?php echo $vLTitle;?> Subject" <?php echo $required;?>>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<label><?php echo $vLTitle;?> Body <?php echo $required_msg;?></label>
											</div>
											<div class="col-lg-6">
												<textarea class="form-control" rows="10" name="<?php echo $vBody;?>"  id="<?php echo $vBody;?>"  placeholder="<?php echo $vLTitle;?> Body" <?php echo $required;?>> <?php echo $$vBody;?></textarea>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-lg-12">
											<input type="submit" class="save btn-info" name="submit" id="submit" value="<?php echo $action;?> Email Template">
										</div>
									</div>
							</form>
						</div>
