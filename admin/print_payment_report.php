    ...
    <body <?php if($_REQUEST['iCompanyId'] != '' || $_REQUEST['iDriverId'] != ''){ ?> onload="window.print();" <?php } ?>>
				...
				<td>
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">      
                        <tr>        
                            ...
                            <td width="20%">&nbsp;<h1><?php echo $COMPANY_NAME?></h1></td>
                        </tr>
							  ...
							  <table border="0" width="100%" style=="border-top: 1px solid #000000; border-left: 1px solid #000000;" align="left" cellpadding="3" cellspacing="0">          
                                    ...
                                    <?
                                      if(count($db_trip) > 0){
                                        ...
                                        ?>
                                    <tr>      
                                       <td valign="top" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?php echo $db_trip[$i]['vRideNo'];?></td>
                                        <td valign="top" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?php echo $db_trip[$i]['drivername'];?></td>
                                        <!--<td valign="top" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?php echo $db_trip[$i]['passanger'];?></td>-->
                                        <td valign="top" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?php echo  date('d-m-Y',strtotime($db_trip[$i]['tTripRequestDate']));?></td>
                                        ...
                                        <!--<td valign="top" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?php echo $db_trip[$i]['iActive'];?></td>
                                        <td valign="top" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?php echo $paymentmode;?></td>
                                        <td valign="top" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;" height="25"><font class=gmattersmallest><?php echo $db_trip[$i]['eDriverPaymentStatus'];?></td>-->
                                    ...
                                    <tr>                                            
                                        ...
                                        <td width="10%" align="right" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;"><?php echo $generalobj->trip_currency($tot_fare);?></td>
                                    </tr>	
                                     ...
                                     <tr>                                            
                                        ...
                                        <td width="10%" align="right" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;"><?php echo $generalobj->trip_currency($tot_site_commission);?></td>
                                    </tr>
                                    ...
                                    <tr>                                            
                                        ...
                                        <td width="10%" align="right" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;"><?php echo $generalobj->trip_currency($tot_promo_discount);?></td>
                                    </tr>
									...
									<tr>                                            
                                        ...
                                        <td width="10%" align="right" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;"><?php echo $generalobj->trip_currency($tot_wallentPayment);?></td>
                                    </tr>									
                                    ...
                                    <tr>                                            
                                        ...
                                        <td width="10%" align="right" style="FONT-WEIGHT: normal; FONT-SIZE: 17px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif; border-bottom: 1px solid #000000; border-right: 1px solid #000000;"><?php echo $generalobj->trip_currency($tot_driver_refund);?></td>
                                    </tr>
                                    <?}?>		
                                </table>
                          </td>
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style=="border-top: 1px solid #000000; border-left: 1px solid #000000;">  
            ...
            <td style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 34px; COLOR: #000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif;border-top: 1px solid #000000; border-left: 1px solid #000000;border-right: 1px solid #000000;border-bottom: 1px solid #000000;">Balance Owing
    				...
    				<td colspan="9" style="text-align:center;FONT-WEIGHT: normal; FONT-SIZE: 34px; COLOR: #FF0000; FONT-FAMILY: tahoma, Verdana, Arial, Helvetica, sans-serif;border-top: 1px solid #000000;border-top: 1px solid #000000; border-left: 1px solid #000000;border-right: 1px solid #000000;border-bottom: 1px solid #000000;"><?php echo $generalobj->trip_currency($tot_site_commission);?>
            </td></tr>
        </table>
    </body>
</html>
