...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
     ...
     <head>
          <meta charset="UTF-8" />
          <title>Admin | Vehicle Type <?php echo  $action; ?></title>
							...
							<?php } ?>		
                                   ...
                                   <form id="vtype" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="vVehicleType"  id="vVehicleType" readonly value="<?php echo  $vVehicleType; ?>"  required>
                                             </div>
                                        </div>
                                        <div class="row">
                                             <div class="col-lg-12">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="fPricePerKM"  id="fPricePerKM" value="<?php echo  $fPricePerKM; ?>" required" onchange="getpriceCheck(this.value)">
                                             </div>
										...
										<div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="fPricePerMin"  id="fPricePerMin" value="<?php echo  $fPricePerMin; ?>"  required onchange="getpriceCheck(this.value)">
										...
										<div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="iBaseFare"  id="iBaseFare" value="<?php echo  $iBaseFare; ?>" required onchange="getpriceCheck(this.value)">
										...
										<div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="fCommision"  id="fCommision" value="<?php echo  $fCommision; ?>" required onchange="getpriceCheck(this.value)">
										...
										<div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="iPersonSize"  id="iPersonSize" value="<?php echo  $iPersonSize; ?>" required onchange="getpriceCheck(this.value),onlydigit(this.value)">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" class="form-control" name="fPickUpPrice"  id="fPickUpPrice" value="<?php echo  $fPickUpPrice; ?>" required onchange="getpriceCheck(this.value)"> 
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-6">
                        										<div class="make-switch" data-on="success" data-off="warning">
                        											<input type="checkbox" id="ePickStatus" onchange="showhidepickuptime();" name="ePickStatus" <?php echo ($id != '' && $ePickStatus == 'Inactive')?'':'checked';?>/>
                        											</div>
                        									</div>
                                        </div>
                                        ...
                                        <div id="showpickuptime" style="display:none;">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" readonly class=" form-control" name="tPickStartTime"  id="tPickStartTime" value="<?php echo  $tPickStartTime; ?>" placeholder="Select Pickup Start Time" required>
                                             </div>
                                         </div>
                                         <div class="row">
                                             <div class="col-lg-12">
                                             ...
                                             <div class="col-lg-6">
                                                  <input type="text" readonly class=" form-control" name="tPickEndTime"  id="tPickEndTime" value="<?php echo  $tPickEndTime; ?>" placeholder="Select Pickup End Time" required>
                                             </div>
                                         </div> 
                                        </div> 
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-6">
                        										<div class="make-switch" data-on="success" data-off="warning">
                        											<input type="checkbox" id="eNightStatus" onchange="showhidenighttime();" name="eNightStatus" <?php echo ($id != '' && $eNightStatus == 'Inactive')?'':'checked';?>/>
                        											</div>
                        									</div>
                                        </div>
                                         ...
                                         <div id="shownighttime" style="display:none;">
                                            <div class="row">
                                               ...
                                               <div class="col-lg-6">
                                                    <input type="text" readonly class=" form-control" name="tNightStartTime"  id="tNightStartTime" value="<?php echo  $tNightStartTime; ?>" placeholder="Select Night Start Time" required>
                                               </div>
                                           </div>
                                           <div class="row">
                                               <div class="col-lg-12">
                                               ...
                                               <div class="col-lg-6">
                                                    <input type="text" readonly class=" form-control" name="tNightEndTime"  id="tNightEndTime" value="<?php echo  $tNightEndTime; ?>" placeholder="Select Night End Time" required>
                                               </div>
                                           </div>                                                    
                                         </div>                                   
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                             	  <?php if($vLogo != '') { ?>
                                             	  <img src="<?php echo $tconfig['tsite_upload_images_vehicle_type']."/".$id."/ios/3x_".$vLogo;?>" style="width:100px;height:100px;">
                                             	  <?}?>
										...
										<div class="row">
                                             ...
                                             <div class="col-lg-6">
                                             	  <?php if($vLogo != '') { ?>
                                             	  <img src="<?php echo $tconfig['tsite_upload_images_vehicle_type']."/".$id."/ios/3x_hover_".$vLogo;?>" style="width:100px;height:100px;">
                                             	  <?}?>
