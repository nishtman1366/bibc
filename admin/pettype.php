...
include_once('../common.php');
	...
	if(checkPermission('PET_TYPE') == false)
                                                  ...
                                                  <div class="table-responsive">
                                                       <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            ...
                                                            <tbody>
                                                                 ...
                                                                 <tr class="gradeA">
                                                                      <td><?php echo  $data_drv[$i]['vTitle_EN']; ?></td>                     
                                  																	  <td>
                                                                     <a href="pettype.php?iPetTypeId=<?php echo  $data_drv[$i]['iPetTypeId']; ?>&Status=<?php echo  ($data_drv[$i]['eStatus'] == "Active") ? 'Inactive' : 'Active' ?>">
                                    																			<button class="btn">
                                                                      ...
                                                                      <td>
                                                                           <a href="pettype_action.php?id=<?php echo  $data_drv[$i]['iPetTypeId']; ?>" style="float: left;">
                                                                        ...
                                                                        <td>     
                                                                           <form name="delete_form" id="delete_form" method="post" action="" onSubmit="return confirm('Are you sure you want to delete record?')" class="margin0">
                                                                                <input type="hidden" name="hdn_del_id" id="hdn_del_id" value="<?php echo  $data_drv[$i]['iPetTypeId']; ?>">
